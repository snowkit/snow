...
// --- General -------------------------------------------
    ...
    value lumen_gl_get_error() {

        return alloc_int( glGetError() );

    } DEFINE_PRIM(lumen_gl_get_error,0);


    value lumen_gl_finish() {

        glFinish();

        return alloc_null();

    } DEFINE_PRIM(lumen_gl_finish,0);


    value lumen_gl_flush() {

        glFlush();

        return alloc_null();

    } DEFINE_PRIM(lumen_gl_flush,0);
    ...
    } DEFINE_PRIM(lumen_gl_enable,1);


    value lumen_gl_disable(value inCap) {
    ...
    } DEFINE_PRIM(lumen_gl_disable,1);


    value lumen_gl_hint(value inTarget, value inValue) {

        glHint(val_int(inTarget),val_int(inValue));

        return alloc_null();

    } DEFINE_PRIM(lumen_gl_hint,2);


    value lumen_gl_line_width(value inWidth) {

        glLineWidth(val_number(inWidth));

        return alloc_null();

    } DEFINE_PRIM(lumen_gl_line_width,1);


    value lumen_gl_get_context_attributes() {
    ...
    value lumen_gl_get_supported_extensions(value ioList) {
    ...
    } DEFINE_PRIM(lumen_gl_get_supported_extensions,1);


    value lumen_gl_front_face(value inFace) {
    ...
    value lumen_gl_get_parameter(value pname_val) {
    ...
    } DEFINE_PRIM(lumen_gl_get_parameter,1);
...
// --- Is -------------------------------------------
    ...
    #define GL_IS(name,Name) \
        ...
        DEFINE_PRIM(lumen_gl_is_##name,1);
...
// --- Program -------------------------------------------
    ...
    } DEFINE_PRIM(lumen_gl_create_program,0);
    ...
    } DEFINE_PRIM(lumen_gl_link_program,1);
    ...
    } DEFINE_PRIM(lumen_gl_validate_program,1);


    value lumen_gl_get_program_info_log(value inId) {
    ...
    } DEFINE_PRIM(lumen_gl_get_program_info_log,1);
    ...
    } DEFINE_PRIM(lumen_gl_delete_program,1);
    ...
    } DEFINE_PRIM(lumen_gl_get_attrib_location,2);
    ...
    value lumen_gl_get_program_parameter(value inId,value inName) {
    ...
    } DEFINE_PRIM(lumen_gl_get_program_parameter,2);


    value lumen_gl_use_program(value inId) {
    ...
    } DEFINE_PRIM(lumen_gl_use_program,1);
    ...
    } DEFINE_PRIM(lumen_gl_get_active_attrib,2);
    ...
    } DEFINE_PRIM(lumen_gl_get_active_uniform,2);
    ...
    value lumen_gl_uniform_matrix(value inLocation, value inTranspose, value inBytes,value inCount){
        ...
        return alloc_null();
    } DEFINE_PRIM(lumen_gl_uniform_matrix,4);


    #define GL_UNFORM_1(TYPE,GET) \
    value lumen_gl_uniform1##TYPE(value inLocation, value inV0) \
    { \
       glUniform1##TYPE(val_int(inLocation),GET(inV0)); \
       return alloc_null(); \
    } DEFINE_PRIM(lumen_gl_uniform1##TYPE,2);

    #define GL_UNFORM_2(TYPE,GET) \
    value lumen_gl_uniform2##TYPE(value inLocation, value inV0,value inV1) \
    { \
       glUniform2##TYPE(val_int(inLocation),GET(inV0),GET(inV1)); \
       return alloc_null(); \
    } DEFINE_PRIM(lumen_gl_uniform2##TYPE,3);

    #define GL_UNFORM_3(TYPE,GET) \
    value lumen_gl_uniform3##TYPE(value inLocation, value inV0,value inV1,value inV2) \
    { \
       glUniform3##TYPE(val_int(inLocation),GET(inV0),GET(inV1),GET(inV2)); \
       return alloc_null(); \
    } DEFINE_PRIM(lumen_gl_uniform3##TYPE,4);

    #define GL_UNFORM_4(TYPE,GET) \
    value lumen_gl_uniform4##TYPE(value inLocation, value inV0,value inV1,value inV2,value inV3) \
    { \
       glUniform4##TYPE(val_int(inLocation),GET(inV0),GET(inV1),GET(inV2),GET(inV3)); \
       return alloc_null(); \
    } DEFINE_PRIM(lumen_gl_uniform4##TYPE,5);
    ...
    } DEFINE_PRIM(lumen_gl_uniform4iv,2);


    value lumen_gl_uniform1fv(value inLocation,value inByteBuffer) {
    ...
    } DEFINE_PRIM(lumen_gl_uniform1fv,2);


    value lumen_gl_uniform2fv(value inLocation,value inByteBuffer) {
    ...
    } DEFINE_PRIM(lumen_gl_uniform2fv,2);


    value lumen_gl_uniform3fv(value inLocation,value inByteBuffer) {
    ...
    } DEFINE_PRIM(lumen_gl_uniform3fv,2);


    value lumen_gl_uniform4fv(value inLocation,value inByteBuffer) {
    ...
    } DEFINE_PRIM(lumen_gl_uniform4fv,2);

    // Attrib

    value lumen_gl_vertex_attrib1f(value inLocation, value inV0) {

        glVertexAttrib1f(val_int(inLocation),val_number(inV0));

        return alloc_null();

    } DEFINE_PRIM(lumen_gl_vertex_attrib1f,2);


    value lumen_gl_vertex_attrib2f(value inLocation, value inV0,value inV1) {

        glVertexAttrib2f(val_int(inLocation),val_number(inV0),val_number(inV1));

        return alloc_null();

    } DEFINE_PRIM(lumen_gl_vertex_attrib2f,3);
    ...
    } DEFINE_PRIM(lumen_gl_vertex_attrib3f,4);
    ...
    } DEFINE_PRIM(lumen_gl_vertex_attrib4f,5);
    ...
    value lumen_gl_vertex_attrib2fv(value inLocation,value inByteBuffer) {
    ...
    } DEFINE_PRIM(lumen_gl_vertex_attrib2fv,2);
    ...
    } DEFINE_PRIM(lumen_gl_vertex_attrib3fv,2);
    ...
    } DEFINE_PRIM(lumen_gl_vertex_attrib4fv,2);
...
// --- Shader -------------------------------------------
    ...
    } DEFINE_PRIM(lumen_gl_delete_shader,1);
    ...
    } DEFINE_PRIM(lumen_gl_shader_source,2);


    value lumen_gl_attach_shader(value inProg,value inShader) {

        glAttachShader(val_int(inProg),val_int(inShader));

        return alloc_null();

    } DEFINE_PRIM(lumen_gl_attach_shader,2);


    value lumen_gl_detach_shader(value inProg,value inShader) {

        glDetachShader(val_int(inProg),val_int(inShader));

        return alloc_null();

    } DEFINE_PRIM(lumen_gl_detach_shader,2);
    ...
    } DEFINE_PRIM(lumen_gl_get_shader_parameter,2);
    ...
    } DEFINE_PRIM(lumen_gl_get_shader_info_log,1);
    ...
    } DEFINE_PRIM(lumen_gl_get_shader_source,1);


    value lumen_gl_get_shader_precision_format(value inShader,value inPrec) {
    ...
    } DEFINE_PRIM(lumen_gl_get_shader_precision_format,2);


// --- Buffer -------------------------------------------


    value lumen_gl_create_buffer() {
    ...
    } DEFINE_PRIM(lumen_gl_create_buffer,0);


    value lumen_gl_delete_buffer(value inId) {
    ...
    } DEFINE_PRIM(lumen_gl_delete_buffer,1);


    value lumen_gl_bind_buffer(value inTarget, value inId ) {

        glBindBuffer(val_int(inTarget),val_int(inId));

        return alloc_null();

    } DEFINE_PRIM(lumen_gl_bind_buffer,2);


    value lumen_gl_buffer_data(value inTarget, value inByteBuffer, value inStart, value inLen, value inUsage) {
    ...
    } DEFINE_PRIM(lumen_gl_buffer_data,5);


    value lumen_gl_buffer_sub_data(value inTarget, value inOffset, value inByteBuffer, value inStart, value inLen) {
    ...
    } DEFINE_PRIM(lumen_gl_buffer_sub_data,5);
    ...
    value lumen_gl_get_vertex_attrib(value index, value name) {
    ...
    } DEFINE_PRIM(lumen_gl_get_vertex_attrib,2);


    value lumen_gl_vertex_attrib_pointer(value *arg, int nargs) {
    ...
    } DEFINE_PRIM_MULT(lumen_gl_vertex_attrib_pointer);
...
// --- Viewports -------------------------------
    ...
    value lumen_gl_viewport(value inX, value inY, value inW,value inH) {

        glViewport(val_int(inX),val_int(inY),val_int(inW),val_int(inH));

        return alloc_null();

    } DEFINE_PRIM(lumen_gl_viewport,4);


    value lumen_gl_scissor(value inX, value inY, value inW,value inH) {

        glScissor(val_int(inX),val_int(inY),val_int(inW),val_int(inH));

        return alloc_null();

    } DEFINE_PRIM(lumen_gl_scissor,4);


    value lumen_gl_clear(value inMask) {

        glClear(val_int(inMask));

        return alloc_null();

    } DEFINE_PRIM(lumen_gl_clear,1);


    value lumen_gl_clear_color(value r,value g, value b, value a) {

        glClearColor(val_number(r),val_number(g),val_number(b),val_number(a));

        return alloc_null();

    } DEFINE_PRIM(lumen_gl_clear_color,4);
    ...
    value lumen_gl_clear_stencil(value stencil) {

        glClearStencil(val_int(stencil));

        return alloc_null();

    } DEFINE_PRIM(lumen_gl_clear_stencil,1);


    value lumen_gl_color_mask(value r,value g, value b, value a) {

        glColorMask(val_bool(r),val_bool(g),val_bool(b),val_bool(a));

        return alloc_null();

    } DEFINE_PRIM(lumen_gl_color_mask,4);


    value lumen_gl_depth_func(value func) {

        glDepthFunc(val_int(func));

        return alloc_null();

    } DEFINE_PRIM(lumen_gl_depth_func,1);


    value lumen_gl_depth_mask(value mask) {

        glDepthMask(val_bool(mask));

        return alloc_null();

    } DEFINE_PRIM(lumen_gl_depth_mask,1);
    ...
    } DEFINE_PRIM(lumen_gl_depth_range,2);


    value lumen_gl_cull_face(value mode) {

        glCullFace(val_int(mode));

        return alloc_null();

    } DEFINE_PRIM(lumen_gl_cull_face,1);


    value lumen_gl_polygon_offset(value factor, value units) {

        glPolygonOffset(val_number(factor), val_number(units));

        return alloc_null();

    } DEFINE_PRIM(lumen_gl_polygon_offset,2);


    value lumen_gl_read_pixels(value *arg, int argCount) {
    ...
    } DEFINE_PRIM_MULT(lumen_gl_read_pixels);


    value lumen_gl_pixel_storei(value pname, value param) {

       glPixelStorei(val_int(pname), val_int(param));

       return alloc_null();

    } DEFINE_PRIM(lumen_gl_pixel_storei,2);


    value lumen_gl_sample_coverage(value f, value invert) {

       glSampleCoverage(val_number(f), val_bool(invert));

       return alloc_null();

    } DEFINE_PRIM(lumen_gl_sample_coverage,2);
...
// --- Texture -------------------------------------------
    ...
    } DEFINE_PRIM(lumen_gl_create_texture,0);


    value lumen_gl_active_texture(value inSlot) {

        glActiveTexture( val_int(inSlot) );

        return alloc_null();

    } DEFINE_PRIM(lumen_gl_active_texture,1);


    value lumen_gl_delete_texture(value inId) {
    ...
    } DEFINE_PRIM(lumen_gl_delete_texture,1);


    value lumen_gl_bind_texture(value inTarget, value inTexture) {
    ...
    } DEFINE_PRIM_MULT(lumen_gl_tex_image_2d);
    ...
    } DEFINE_PRIM_MULT(lumen_gl_tex_sub_image_2d);
    ...
    } DEFINE_PRIM_MULT(lumen_gl_compressed_tex_image_2d);


    value lumen_gl_compressed_tex_sub_image_2d(value *arg, int argCount) {
    ...
    } DEFINE_PRIM_MULT(lumen_gl_compressed_tex_sub_image_2d);


    value lumen_gl_tex_parameterf(value inTarget, value inPName, value inVal) {

        glTexParameterf(val_int(inTarget), val_int(inPName), val_number(inVal) );

        return alloc_null();

    } DEFINE_PRIM(lumen_gl_tex_parameterf,3);


    value lumen_gl_tex_parameteri(value inTarget, value inPName, value inVal) {

        glTexParameterf(val_int(inTarget), val_int(inPName), val_int(inVal) );

        return alloc_null();

    } DEFINE_PRIM(lumen_gl_tex_parameteri,3);


    value lumen_gl_copy_tex_image_2d(value *arg, int argCount) {
    ...
    } DEFINE_PRIM_MULT(lumen_gl_copy_tex_image_2d);


    value lumen_gl_copy_tex_sub_image_2d(value *arg, int argCount) {
