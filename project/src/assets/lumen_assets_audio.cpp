...
//OGG files
    ...
    bool audio_load_info_ogg( QuickVec<unsigned char> &out_buffer, const char* _id, OGG_file_source*& ogg_source, bool read ) {
        ...
        audio_seek_bytes_ogg(ogg_source, 0);
        ...
        if(read) {
            audio_read_bytes_ogg( ogg_source, out_buffer, 0, total_length );
        }
    ...
    bool audio_read_bytes_ogg( OGG_file_source* ogg_source, QuickVec<unsigned char> &out_buffer, long start, long len ) {
        ...
        if(start != -1) {
            ...
            audio_seek_bytes_ogg( ogg_source, start );
        }
...
//WAV files
    ...
    bool audio_load_info_wav( QuickVec<unsigned char> &out_buffer, const char *_id, WAV_file_source*& wav_source, bool read ) {
        ...
        if(read) {
            audio_read_bytes_wav( wav_source, out_buffer, -1, wav_source->length_pcm );
        }
    ...
    bool audio_read_bytes_wav( WAV_file_source* wav_source, QuickVec<unsigned char> &out_buffer, long start, long len ) {
        ...
        if(start != -1) {
            ...
            audio_seek_bytes_wav( wav_source, start );
        }
...
//PCM files
    ...
    bool audio_load_info_pcm( QuickVec<unsigned char> &out_buffer, const char *_id, PCM_file_source*& pcm_source, bool read ) {
        ...
        if(read) {
            audio_read_bytes_pcm( pcm_source, out_buffer, -1, pcm_source->length_pcm );
        }
    ...
    bool audio_read_bytes_pcm( PCM_file_source* pcm_source, QuickVec<unsigned char> &out_buffer, long start, long len ) {
        ...
        if(start != -1) {
            ...
            audio_seek_bytes_pcm( pcm_source, start );
        }
