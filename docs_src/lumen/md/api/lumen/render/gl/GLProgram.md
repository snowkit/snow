...
<h3>Members</h3> <hr/><span class="member apipage">
            <a name="shaders"><a class="lift" href="#shaders">shaders</a></a><code class="signature apipage">shaders : [Array](http://api.haxe.org/Array.html)&lt;[lumen.platform.native.render.gl.GLShader](#lumen.platform.native.render.gl.GLShader)&gt;</code><br/></span>
        <span class="small_desc_flat"></span>

<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="attach"><a class="lift" href="#attach">attach</a></a><code class="signature apipage">attach(shader:<span>[lumen.platform.native.render.gl.GLShader](#lumen.platform.native.render.gl.GLShader)</span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
            <a name="getShaders"><a class="lift" href="#getShaders">getShaders</a></a><code class="signature apipage">getShaders() : [Array](http://api.haxe.org/Array.html)&lt;[lumen.platform.native.render.gl.GLShader](#lumen.platform.native.render.gl.GLShader)&gt;</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
