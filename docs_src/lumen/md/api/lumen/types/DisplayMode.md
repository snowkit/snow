...
<h3>Members</h3> <hr/><span class="member apipage">
        ...
        <span class="small_desc_flat"></span><span class="member apipage">
            <a name="refresh_rate"><a class="lift" href="#refresh_rate">refresh\_rate</a></a><code class="signature apipage">refresh\_rate : [Int](http://api.haxe.org/Int.html)</code><br/></span>
        <span class="small_desc_flat"></span><span class="member apipage">
