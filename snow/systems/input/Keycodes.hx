...
@:noCompletion class Keycodes {
    ...
    public static var capslock(default, never) : Int           = from_scan(Scancodes.capslock);

    public static var f1(default, never) : Int                 = from_scan(Scancodes.f1);
    public static var f2(default, never) : Int                 = from_scan(Scancodes.f2);
    public static var f3(default, never) : Int                 = from_scan(Scancodes.f3);
    public static var f4(default, never) : Int                 = from_scan(Scancodes.f4);
    public static var f5(default, never) : Int                 = from_scan(Scancodes.f5);
    public static var f6(default, never) : Int                 = from_scan(Scancodes.f6);
    public static var f7(default, never) : Int                 = from_scan(Scancodes.f7);
    public static var f8(default, never) : Int                 = from_scan(Scancodes.f8);
    public static var f9(default, never) : Int                 = from_scan(Scancodes.f9);
    public static var f10(default, never) : Int                = from_scan(Scancodes.f10);
    public static var f11(default, never) : Int                = from_scan(Scancodes.f11);
    public static var f12(default, never) : Int                = from_scan(Scancodes.f12);

    public static var printscreen(default, never) : Int        = from_scan(Scancodes.printscreen);
    public static var scrolllock(default, never) : Int         = from_scan(Scancodes.scrolllock);
    public static var pause(default, never) : Int              = from_scan(Scancodes.pause);
    public static var insert(default, never) : Int             = from_scan(Scancodes.insert);
    public static var home(default, never) : Int               = from_scan(Scancodes.home);
    public static var pageup(default, never) : Int             = from_scan(Scancodes.pageup);
    public static inline var delete : Int        = 127;
    public static var end(default, never) : Int                = from_scan(Scancodes.end);
    public static var pagedown(default, never) : Int           = from_scan(Scancodes.pagedown);
    public static var right(default, never) : Int              = from_scan(Scancodes.right);
    public static var left(default, never) : Int               = from_scan(Scancodes.left);
    public static var down(default, never) : Int               = from_scan(Scancodes.down);
    public static var up(default, never) : Int                 = from_scan(Scancodes.up);

    public static var numlockclear(default, never) : Int       = from_scan(Scancodes.numlockclear);
    public static var kp_divide(default, never) : Int          = from_scan(Scancodes.kp_divide);
    public static var kp_multiply(default, never) : Int        = from_scan(Scancodes.kp_multiply);
    public static var kp_minus(default, never) : Int           = from_scan(Scancodes.kp_minus);
    public static var kp_plus(default, never) : Int            = from_scan(Scancodes.kp_plus);
    public static var kp_enter(default, never) : Int           = from_scan(Scancodes.kp_enter);
    public static var kp_1(default, never) : Int               = from_scan(Scancodes.kp_1);
    public static var kp_2(default, never) : Int               = from_scan(Scancodes.kp_2);
    public static var kp_3(default, never) : Int               = from_scan(Scancodes.kp_3);
    public static var kp_4(default, never) : Int               = from_scan(Scancodes.kp_4);
    public static var kp_5(default, never) : Int               = from_scan(Scancodes.kp_5);
    public static var kp_6(default, never) : Int               = from_scan(Scancodes.kp_6);
    public static var kp_7(default, never) : Int               = from_scan(Scancodes.kp_7);
    public static var kp_8(default, never) : Int               = from_scan(Scancodes.kp_8);
    public static var kp_9(default, never) : Int               = from_scan(Scancodes.kp_9);
    public static var kp_0(default, never) : Int               = from_scan(Scancodes.kp_0);
    public static var kp_period(default, never) : Int          = from_scan(Scancodes.kp_period);

    public static var application(default, never) : Int        = from_scan(Scancodes.application);
    public static var power(default, never) : Int              = from_scan(Scancodes.power);
    public static var kp_equals(default, never) : Int          = from_scan(Scancodes.kp_equals);
    public static var f13(default, never) : Int                = from_scan(Scancodes.f13);
    public static var f14(default, never) : Int                = from_scan(Scancodes.f14);
    public static var f15(default, never) : Int                = from_scan(Scancodes.f15);
    public static var f16(default, never) : Int                = from_scan(Scancodes.f16);
    public static var f17(default, never) : Int                = from_scan(Scancodes.f17);
    public static var f18(default, never) : Int                = from_scan(Scancodes.f18);
    public static var f19(default, never) : Int                = from_scan(Scancodes.f19);
    public static var f20(default, never) : Int                = from_scan(Scancodes.f20);
    public static var f21(default, never) : Int                = from_scan(Scancodes.f21);
    public static var f22(default, never) : Int                = from_scan(Scancodes.f22);
    public static var f23(default, never) : Int                = from_scan(Scancodes.f23);
    public static var f24(default, never) : Int                = from_scan(Scancodes.f24);
    public static var execute(default, never) : Int            = from_scan(Scancodes.execute);
    public static var help(default, never) : Int               = from_scan(Scancodes.help);
    public static var menu(default, never) : Int               = from_scan(Scancodes.menu);
    public static var select(default, never) : Int             = from_scan(Scancodes.select);
    public static var stop(default, never) : Int               = from_scan(Scancodes.stop);
    public static var again(default, never) : Int              = from_scan(Scancodes.again);
    public static var undo(default, never) : Int               = from_scan(Scancodes.undo);
    public static var cut(default, never) : Int                = from_scan(Scancodes.cut);
    public static var copy(default, never) : Int               = from_scan(Scancodes.copy);
    public static var paste(default, never) : Int              = from_scan(Scancodes.paste);
    public static var find(default, never) : Int               = from_scan(Scancodes.find);
    public static var mute(default, never) : Int               = from_scan(Scancodes.mute);
    public static var volumeup(default, never) : Int           = from_scan(Scancodes.volumeup);
    public static var volumedown(default, never) : Int         = from_scan(Scancodes.volumedown);
    public static var kp_comma(default, never) : Int           = from_scan(Scancodes.kp_comma);
    public static var kp_equalsas400(default, never) : Int     = from_scan(Scancodes.kp_equalsas400);

    public static var alterase(default, never) : Int           = from_scan(Scancodes.alterase);
    public static var sysreq(default, never) : Int             = from_scan(Scancodes.sysreq);
    public static var cancel(default, never) : Int             = from_scan(Scancodes.cancel);
    public static var clear(default, never) : Int              = from_scan(Scancodes.clear);
    public static var prior(default, never) : Int              = from_scan(Scancodes.prior);
    public static var return2(default, never) : Int            = from_scan(Scancodes.return2);
    public static var separator(default, never) : Int          = from_scan(Scancodes.separator);
    public static var out(default, never) : Int                = from_scan(Scancodes.out);
    public static var oper(default, never) : Int               = from_scan(Scancodes.oper);
    public static var clearagain(default, never) : Int         = from_scan(Scancodes.clearagain);
    public static var crsel(default, never) : Int              = from_scan(Scancodes.crsel);
    public static var exsel(default, never) : Int              = from_scan(Scancodes.exsel);

    public static var kp_00(default, never) : Int              = from_scan(Scancodes.kp_00);
    public static var kp_000(default, never) : Int             = from_scan(Scancodes.kp_000);
    public static var thousandsseparator(default, never) : Int = from_scan(Scancodes.thousandsseparator);
    public static var decimalseparator(default, never) : Int   = from_scan(Scancodes.decimalseparator);
    public static var currencyunit(default, never) : Int       = from_scan(Scancodes.currencyunit);
    public static var currencysubunit(default, never) : Int    = from_scan(Scancodes.currencysubunit);
    public static var kp_leftparen(default, never) : Int       = from_scan(Scancodes.kp_leftparen);
    public static var kp_rightparen(default, never) : Int      = from_scan(Scancodes.kp_rightparen);
    public static var kp_leftbrace(default, never) : Int       = from_scan(Scancodes.kp_leftbrace);
    public static var kp_rightbrace(default, never) : Int      = from_scan(Scancodes.kp_rightbrace);
    public static var kp_tabv(default, never) : Int            = from_scan(Scancodes.kp_tab);
    public static var kp_backspace(default, never) : Int       = from_scan(Scancodes.kp_backspace);
    public static var kp_a(default, never) : Int               = from_scan(Scancodes.kp_a);
    public static var kp_b(default, never) : Int               = from_scan(Scancodes.kp_b);
    public static var kp_c(default, never) : Int               = from_scan(Scancodes.kp_c);
    public static var kp_d(default, never) : Int               = from_scan(Scancodes.kp_d);
    public static var kp_e(default, never) : Int               = from_scan(Scancodes.kp_e);
    public static var kp_f(default, never) : Int               = from_scan(Scancodes.kp_f);
    public static var kp_xor(default, never) : Int             = from_scan(Scancodes.kp_xor);
    public static var kp_power(default, never) : Int           = from_scan(Scancodes.kp_power);
    public static var kp_percent(default, never) : Int         = from_scan(Scancodes.kp_percent);
    public static var kp_less(default, never) : Int            = from_scan(Scancodes.kp_less);
    public static var kp_greater(default, never) : Int         = from_scan(Scancodes.kp_greater);
    public static var kp_ampersand(default, never) : Int       = from_scan(Scancodes.kp_ampersand);
    public static var kp_dblampersand(default, never) : Int    = from_scan(Scancodes.kp_dblampersand);
    public static var kp_verticalbar(default, never) : Int     = from_scan(Scancodes.kp_verticalbar);
    public static var kp_dblverticalbar(default, never) : Int  = from_scan(Scancodes.kp_dblverticalbar);
    public static var kp_colon(default, never) : Int           = from_scan(Scancodes.kp_colon);
    public static var kp_hash(default, never) : Int            = from_scan(Scancodes.kp_hash);
    public static var kp_space(default, never) : Int           = from_scan(Scancodes.kp_space);
    public static var kp_at(default, never) : Int              = from_scan(Scancodes.kp_at);
    public static var kp_exclam(default, never) : Int          = from_scan(Scancodes.kp_exclam);
    public static var kp_memstore(default, never) : Int        = from_scan(Scancodes.kp_memstore);
    public static var kp_memrecall(default, never) : Int       = from_scan(Scancodes.kp_memrecall);
    public static var kp_memclear(default, never) : Int        = from_scan(Scancodes.kp_memclear);
    public static var kp_memadd(default, never) : Int          = from_scan(Scancodes.kp_memadd);
    public static var kp_memsubtract(default, never) : Int     = from_scan(Scancodes.kp_memsubtract);
    public static var kp_memmultiply(default, never) : Int     = from_scan(Scancodes.kp_memmultiply);
    public static var kp_memdivide(default, never) : Int       = from_scan(Scancodes.kp_memdivide);
    public static var kp_plusminus(default, never) : Int       = from_scan(Scancodes.kp_plusminus);
    public static var kp_clear(default, never) : Int           = from_scan(Scancodes.kp_clear);
    public static var kp_clearentry(default, never) : Int      = from_scan(Scancodes.kp_clearentry);
    public static var kp_binary(default, never) : Int          = from_scan(Scancodes.kp_binary);
    public static var kp_octal(default, never) : Int           = from_scan(Scancodes.kp_octal);
    public static var kp_decimal(default, never) : Int         = from_scan(Scancodes.kp_decimal);
    public static var kp_hexadecimal(default, never) : Int     = from_scan(Scancodes.kp_hexadecimal);

    public static var lctrl(default, never) : Int              = from_scan(Scancodes.lctrl);
    public static var lshift(default, never) : Int             = from_scan(Scancodes.lshift);
    public static var lalt(default, never) : Int               = from_scan(Scancodes.lalt);
    public static var lmeta(default, never) : Int              = from_scan(Scancodes.lmeta);
    public static var rctrl(default, never) : Int              = from_scan(Scancodes.rctrl);
    public static var rshift(default, never) : Int             = from_scan(Scancodes.rshift);
    public static var ralt(default, never) : Int               = from_scan(Scancodes.ralt);
    public static var rmeta(default, never) : Int              = from_scan(Scancodes.rmeta);

    public static var mode(default, never) : Int               = from_scan(Scancodes.mode);

    public static var audionext(default, never) : Int          = from_scan(Scancodes.audionext);
    public static var audioprev(default, never) : Int          = from_scan(Scancodes.audioprev);
    public static var audiostop(default, never) : Int          = from_scan(Scancodes.audiostop);
    public static var audioplay(default, never) : Int          = from_scan(Scancodes.audioplay);
    public static var audiomute(default, never) : Int          = from_scan(Scancodes.audiomute);
    public static var mediaselect(default, never) : Int        = from_scan(Scancodes.mediaselect);
    public static var www(default, never) : Int                = from_scan(Scancodes.www);
    public static var mail(default, never) : Int               = from_scan(Scancodes.mail);
    public static var calculator(default, never) : Int         = from_scan(Scancodes.calculator);
    public static var computer(default, never) : Int           = from_scan(Scancodes.computer);
    public static var ac_search(default, never) : Int          = from_scan(Scancodes.ac_search);
    public static var ac_home(default, never) : Int            = from_scan(Scancodes.ac_home);
    public static var ac_back(default, never) : Int            = from_scan(Scancodes.ac_back);
    public static var ac_forward(default, never) : Int         = from_scan(Scancodes.ac_forward);
    public static var ac_stop(default, never) : Int            = from_scan(Scancodes.ac_stop);
    public static var ac_refresh(default, never) : Int         = from_scan(Scancodes.ac_refresh);
    public static var ac_bookmarks(default, never) : Int       = from_scan(Scancodes.ac_bookmarks);

    public static var brightnessdown(default, never) : Int     = from_scan(Scancodes.brightnessdown);
    public static var brightnessup(default, never) : Int       = from_scan(Scancodes.brightnessup);
    public static var displayswitch(default, never) : Int      = from_scan(Scancodes.displayswitch);
    public static var kbdillumtoggle(default, never) : Int     = from_scan(Scancodes.kbdillumtoggle);
    public static var kbdillumdown(default, never) : Int       = from_scan(Scancodes.kbdillumdown);
    public static var kbdillumup(default, never) : Int         = from_scan(Scancodes.kbdillumup);
    public static var eject(default, never) : Int              = from_scan(Scancodes.eject);
    public static var sleep(default, never) : Int              = from_scan(Scancodes.sleep);
