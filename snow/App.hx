...
//override these in your game class
    ...
    public function get_runtime_config() : Dynamic {
       ...
       return App.get_default_runtime_config( app );
    ...
    public function get_window_config() : WindowConfig {
        ...
        return App.get_default_window_config( app );
    ...
    public function get_asset_list() : Array<AssetInfo> {
        ...
        return App.get_default_asset_list( app );
    ...
    public static function get_default_runtime_config( app:Snow ) : Dynamic {
        ...
        /** handles the default method of parsing the file manifest list as json, stored in an array and returned.
            To change this behavior override `get_asset_list`. This is called by default in get_asset_list. */
    ...
    } //get_default_asset_list


        /** returns a already configured default value window config to set only specific values against in your get_window_config function */
    public static function get_default_window_config( app:Snow ) : WindowConfig {
