...
//override these in your game class
    ...
    public function get_default_window_config() : WindowConfig {
        ...
        /** override this with your own function to change window flags, only used by specifying that snow must create a default window */
