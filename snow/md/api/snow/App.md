...
<span class="method apipage">
            ...
            <code class="signature apipage">ongamepaddevice(gamepad:[Int](http://api.haxe.org/Int.html)<span></span>, id:[String](http://api.haxe.org/String.html)<span></span>, type:[snow.types.GamepadDeviceEventType](../../api/snow/types/GamepadDeviceEventType.html)<span></span>, timestamp:[Float](http://api.haxe.org/Float.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Called for you when a gamepad is connected or disconnected, use `which` to determine gamepad id. 
            `id` is the string name identifier for the controller, specified from the system.</span>
...
<span class="method apipage">
            <a name="ontickend"><a class="lift" href="#ontickend">ontickend</a></a><div class="clear"></div>
            <code class="signature apipage">ontickend() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Called each frame *after* everything, at the end of the frame. Use with understanding.</span>


</span>
<span class="method apipage">
            <a name="ontickstart"><a class="lift" href="#ontickstart">ontickstart</a></a><div class="clear"></div>
            <code class="signature apipage">ontickstart() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Called each frame *before* everything, the beginning of the frame. Use with understanding.</span>
