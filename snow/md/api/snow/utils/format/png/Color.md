...
<h3>Values</h3> <hr/><span class="member signature apipage">
            <a name="ColGrey"><a class="lift" href="#ColGrey">ColGrey</a></a>
        </span>
        <span class="small_desc_flat"> _no description_ </span><span class="member signature apipage">
            <a name="ColTrue"><a class="lift" href="#ColTrue">ColTrue</a></a>
        </span>
        <span class="small_desc_flat"> _no description_ </span><span class="member signature apipage">
            <a name="ColIndexed"><a class="lift" href="#ColIndexed">ColIndexed</a></a>
        </span>
