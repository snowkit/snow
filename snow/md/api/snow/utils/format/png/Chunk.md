...
<h3>Values</h3> <hr/><span class="member signature apipage">
            <a name="CEnd"><a class="lift" href="#CEnd">CEnd</a></a>
        </span>
        <span class="small_desc_flat"> _no description_ </span><span class="member signature apipage">
            <a name="CHeader"><a class="lift" href="#CHeader">CHeader</a></a>
        </span>
        <span class="small_desc_flat"> _no description_ </span><span class="member signature apipage">
            <a name="CData"><a class="lift" href="#CData">CData</a></a>
        </span>
        <span class="small_desc_flat"> _no description_ </span><span class="member signature apipage">
            <a name="CPalette"><a class="lift" href="#CPalette">CPalette</a></a>
        </span>
        <span class="small_desc_flat"> _no description_ </span><span class="member signature apipage">
            <a name="CUnknown"><a class="lift" href="#CUnknown">CUnknown</a></a>
        </span>
