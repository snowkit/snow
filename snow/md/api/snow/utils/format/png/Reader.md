...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="checkCRC"><a class="lift" href="#checkCRC">checkCRC</a></a><div class="clear"></div>
                <code class="signature apipage">checkCRC : [Bool](http://api.haxe.org/Bool.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/>


<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="new"><a class="lift" href="#new">new</a></a><div class="clear"></div>
            <code class="signature apipage">new(i:[haxe.io.Input](http://api.haxe.org/haxe/io/Input.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="read"><a class="lift" href="#read">read</a></a><div class="clear"></div>
            <code class="signature apipage">read() : [snow.utils.format.png.Data](../../../../../api/snow/utils/format/png/Data.html)</code><br/><span class="small_desc_flat"></span>
