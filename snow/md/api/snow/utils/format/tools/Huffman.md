...
<h3>Values</h3> <hr/><span class="member signature apipage">
            <a name="Found"><a class="lift" href="#Found">Found</a></a>
        </span>
        <span class="small_desc_flat"> _no description_ </span><span class="member signature apipage">
            <a name="NeedBit"><a class="lift" href="#NeedBit">NeedBit</a></a>
        </span>
        <span class="small_desc_flat"> _no description_ </span><span class="member signature apipage">
            <a name="NeedBits"><a class="lift" href="#NeedBits">NeedBits</a></a>
        </span>
