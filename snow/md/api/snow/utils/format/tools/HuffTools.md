...
<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="make"><a class="lift" href="#make">make</a></a><div class="clear"></div>
            <code class="signature apipage">make(lengths:[Array](http://api.haxe.org/Array.html)&lt;[Int](http://api.haxe.org/Int.html)&gt;<span></span>, pos:[Int](http://api.haxe.org/Int.html)<span></span>, nlengths:[Int](http://api.haxe.org/Int.html)<span></span>, maxbits:[Int](http://api.haxe.org/Int.html)<span></span>) : [snow.utils.format.tools.Huffman](../../../../../api/snow/utils/format/tools/Huffman.html)</code><br/><span class="small_desc_flat"></span>
