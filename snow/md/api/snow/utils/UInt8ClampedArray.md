...
<small>`snow.utils.UInt8ClampedArray`</small>



<hr/>

`typedef`&nbsp;alias of `snow.platform.native.utils.UInt8ClampedArray`   
...
<h3>Properties</h3> <hr/><span class="member apipage">
                <a name="BYTES_PER_ELEMENT"><a class="lift" href="#BYTES_PER_ELEMENT">BYTES\_PER\_ELEMENT</a></a><div class="clear"></div>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">new(bufferOrArray:[Dynamic](#)<span></span>, start:[Int](http://api.haxe.org/Int.html)<span>=0</span>, length:[Int](http://api.haxe.org/Int.html)<span>=null</span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="set"><a class="lift" href="#set">set</a></a><div class="clear"></div>
            <code class="signature apipage">set(bufferOrArray:[Dynamic](#)<span></span>, offset:[Int](http://api.haxe.org/Int.html)<span>=0</span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="subarray"><a class="lift" href="#subarray">subarray</a></a><div class="clear"></div>
            <code class="signature apipage">subarray(start:[Int](http://api.haxe.org/Int.html)<span></span>, end:[Int](http://api.haxe.org/Int.html)<span>=null</span>) : [snow.platform.native.utils.UInt8ClampedArray](../../../api/snow/platform/native/utils/UInt8ClampedArray.html)</code><br/><span class="small_desc_flat"></span>
