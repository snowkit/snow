...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">load(library:[String](http://api.haxe.org/String.html)<span></span>, method:[String](http://api.haxe.org/String.html)<span></span>, args:[Int](http://api.haxe.org/Int.html)<span>=0</span>) : [Dynamic](#)</code><br/><span class="small_desc_flat"></span>
