...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                ...
                <code class="signature apipage">manager : [snow.io.IO](../../../api/snow/io/IO.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/>


<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="destroy"><a class="lift" href="#destroy">destroy</a></a><div class="clear"></div>
            <code class="signature apipage">destroy() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Called when the IO manager destroys this system</span>


</span>
<span class="method apipage">
            <a name="dialog_folder"><a class="lift" href="#dialog_folder">dialog\_folder</a></a><div class="clear"></div>
            <code class="signature apipage">dialog\_folder(\_title:[String](http://api.haxe.org/String.html)<span>=&#x27;Select folder&#x27;</span>) : [String](http://api.haxe.org/String.html)</code><br/><span class="small_desc_flat">Call this to open a native platform folder select dialog.
...
<span class="method apipage">
            ...
            <code class="signature apipage">dialog\_open(\_title:[String](http://api.haxe.org/String.html)<span>=&#x27;Select file&#x27;</span>, \_filters:[Array](http://api.haxe.org/Array.html)&lt;[snow.types.FileFilter](../../../api/snow/types/FileFilter.html)&gt;<span>=null</span>) : [String](http://api.haxe.org/String.html)</code><br/><span class="small_desc_flat">Call this to open a native platform file open dialog.
                Returns a blank string if they cancel or any error occurs.
                supports: `windows` `mac` `linux`</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">dialog\_save(\_title:[String](http://api.haxe.org/String.html)<span>=&#x27;Save file&#x27;</span>, \_filter:[snow.types.FileFilter](../../../api/snow/types/FileFilter.html)<span>=null</span>) : [String](http://api.haxe.org/String.html)</code><br/><span class="small_desc_flat">Call this to open a native platform file save dialog.
                Returns a blank string if they cancel or any error occurs.
                supports:`windows` `mac` `linux`</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">init() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Called when the IO manager initiates this system</span>


</span>
<span class="method apipage">
            <a name="on_event"><a class="lift" href="#on_event">on\_event</a></a><div class="clear"></div>
            <code class="signature apipage">on\_event(\_event:[snow.types.SystemEvent](../../../api/snow/types/SystemEvent.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Called when the IO manager forwards an event to this system</span>


</span>
<span class="method apipage">
            <a name="process"><a class="lift" href="#process">process</a></a><div class="clear"></div>
            <code class="signature apipage">process() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Called when the IO manager updates this system</span>
