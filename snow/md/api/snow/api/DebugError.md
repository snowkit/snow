...
<h1>DebugError</h1>
<small>`snow.api.DebugError`</small>
...
<h3>Values</h3> <hr/><span class="member signature apipage">
            <a name="assertion"><a class="lift" href="#assertion">assertion</a></a>
        </span>
        <span class="small_desc_flat"> _no description_ </span><span class="member signature apipage">
            <a name="null_assertion"><a class="lift" href="#null_assertion">null\_assertion</a></a>
        </span>
