...
<h1>FileSeek_Impl_</h1>
<small>`snow.api._File.FileSeek_Impl_`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="cur"><a class="lift" href="#cur">cur</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">cur : [snow.api.FileSeek](../../../../api/snow/api/FileSeek.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="end"><a class="lift" href="#end">end</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">end : [snow.api.FileSeek](../../../../api/snow/api/FileSeek.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="set"><a class="lift" href="#set">set</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">set : [snow.api.FileSeek](../../../../api/snow/api/FileSeek.html)</code><br/></span>
