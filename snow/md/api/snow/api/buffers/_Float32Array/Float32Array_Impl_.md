...
<h1>Float32Array_Impl_</h1>
<small>`snow.api.buffers._Float32Array.Float32Array_Impl_`</small>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">fromBytes(bytes:[haxe.io.Bytes](http://api.haxe.org/haxe/io/Bytes.html)<span></span>, byteOffset:[Int](http://api.haxe.org/Int.html)<span></span>, len:[Int](http://api.haxe.org/Int.html)<span></span>) : [snow.api.buffers.Float32Array](../../../../../api/snow/api/buffers/Float32Array.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">subarray(this:[snow.api.buffers.ArrayBufferView](../../../../../api/snow/api/buffers/ArrayBufferView.html)<span></span>, begin:[Int](http://api.haxe.org/Int.html)<span></span>, end:[Int](http://api.haxe.org/Int.html)<span></span>) : [snow.api.buffers.Float32Array](../../../../../api/snow/api/buffers/Float32Array.html)</code><br/><span class="small_desc_flat"></span>
