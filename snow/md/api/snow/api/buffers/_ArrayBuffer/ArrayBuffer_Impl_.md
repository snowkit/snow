...
<h1>ArrayBuffer_Impl_</h1>
<small>`snow.api.buffers._ArrayBuffer.ArrayBuffer_Impl_`</small>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">\_new(byteLength:[Int](http://api.haxe.org/Int.html)<span></span>) : [snow.api.buffers.ArrayBuffer](../../../../../api/snow/api/buffers/ArrayBuffer.html)</code><br/><span class="small_desc_flat"></span>
