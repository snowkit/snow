...
<h1>Float64Array_Impl_</h1>
<small>`snow.api.buffers._Float64Array.Float64Array_Impl_`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="BYTES_PER_ELEMENT"><a class="lift" href="#BYTES_PER_ELEMENT">BYTES\_PER\_ELEMENT</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">BYTES\_PER\_ELEMENT : [Int](http://api.haxe.org/Int.html)</code><br/></span>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">fromBytes(bytes:[haxe.io.Bytes](http://api.haxe.org/haxe/io/Bytes.html)<span></span>, byteOffset:[Int](http://api.haxe.org/Int.html)<span></span>, len:[Int](http://api.haxe.org/Int.html)<span></span>) : [snow.api.buffers.Float64Array](../../../../../api/snow/api/buffers/Float64Array.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="subarray"><a class="lift" href="#subarray">subarray</a></a><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">subarray(this:[snow.api.buffers.ArrayBufferView](../../../../../api/snow/api/buffers/ArrayBufferView.html)<span></span>, begin:[Int](http://api.haxe.org/Int.html)<span></span>, end:[Int](http://api.haxe.org/Int.html)<span></span>) : [snow.api.buffers.Float64Array](../../../../../api/snow/api/buffers/Float64Array.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="toBytes"><a class="lift" href="#toBytes">toBytes</a></a><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">toBytes(this:[snow.api.buffers.ArrayBufferView](../../../../../api/snow/api/buffers/ArrayBufferView.html)<span></span>) : [haxe.io.Bytes](http://api.haxe.org/haxe/io/Bytes.html)</code><br/><span class="small_desc_flat"></span>
