...
<h1>PromiseState_Impl_</h1>
<small>`snow.api._Promise.PromiseState_Impl_`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="fulfilled"><a class="lift" href="#fulfilled">fulfilled</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">fulfilled : [snow.api.PromiseState](../../../../api/snow/api/PromiseState.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="pending"><a class="lift" href="#pending">pending</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">pending : [snow.api.PromiseState](../../../../api/snow/api/PromiseState.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="rejected"><a class="lift" href="#rejected">rejected</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">rejected : [snow.api.PromiseState](../../../../api/snow/api/PromiseState.html)</code><br/></span>
