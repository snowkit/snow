...
meta: @:directlyUsed, @:allow(snow.Snow)</span>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">delay(\_time:[Float](http://api.haxe.org/Float.html)<span></span>, \_f:[Dynamic](#)<span></span>) : [snow.api.Timer](../../../api/snow/api/Timer.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="measure"><a class="lift" href="#measure">measure</a></a><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">measure&lt;T&gt;(f:[Dynamic](#)<span></span>, pos:[haxe.PosInfos](http://api.haxe.org/haxe/PosInfos.html)<span></span>) : [measure.T](#)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">run() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
