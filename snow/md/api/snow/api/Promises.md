...
meta: @:directlyUsed, @:keep, @:allow(snow.api.Promise)</span>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="step"><a class="lift" href="#step">step</a></a><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">step() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Call this once when you want to propagate promises</span>
