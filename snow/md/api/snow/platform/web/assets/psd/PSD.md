...
<h1>PSD</h1>
<small>`snow.platform.web.assets.psd.PSD`</small>
...
<span class="method apipage">
            ...
            <code class="signature apipage">open(\_url:[String](http://api.haxe.org/String.html)<span></span>, \_psd\_onload:[](#)&nbsp;-&gt; [Void](http://api.haxe.org/Void.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
