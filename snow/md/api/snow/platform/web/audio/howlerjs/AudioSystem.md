...
`class`extends <code><span>snow.platform.web.audio.AudioSystem</span></code>
<span class="meta">
...
<h3>Methods</h3> <hr/><span class="method apipage">
    ...
    <span class="method apipage">
            <a name="_on_end"><a class="lift" href="#_on_end">\_on\_end</a></a> <div class="clear"></div><code class="signature apipage">\_on\_end(handle:[snow.types.AudioHandle](#)<span></span>) : [Void](#)</code><br/><span class="small_desc_flat"></span>
        </span>
    <span class="method apipage">
