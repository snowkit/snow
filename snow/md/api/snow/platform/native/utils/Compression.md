...
<h3>Values</h3> <hr/><span class="member signature apipage">
            <a name="DEFLATE"><a class="lift" href="#DEFLATE">DEFLATE</a></a>
        </span>
        <span class="small_desc_flat"> _no description_ </span><span class="member signature apipage">
            <a name="ZLIB"><a class="lift" href="#ZLIB">ZLIB</a></a>
        </span>
        <span class="small_desc_flat"> _no description_ </span><span class="member signature apipage">
            <a name="LZMA"><a class="lift" href="#LZMA">LZMA</a></a>
        </span>
        <span class="small_desc_flat"> _no description_ </span><span class="member signature apipage">
            <a name="GZIP"><a class="lift" href="#GZIP">GZIP</a></a>
        </span>
