...
<span class="method apipage">
            ...
            <code class="signature apipage">subarray(start:[Int](http://api.haxe.org/Int.html)<span></span>, end:[Int](http://api.haxe.org/Int.html)<span>=null</span>) : [snow.platform.native.utils.UInt32Array](../../../../../api/snow/platform/native/utils/UInt32Array.html)</code><br/><span class="small_desc_flat"></span>
