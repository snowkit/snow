...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">typed(ke\_type:[Int](http://api.haxe.org/Int.html)<span></span>) : [snow.platform.native.input.sdl.KeyEventType](../../../../../../api/snow/platform/native/input/sdl/KeyEventType.html)</code><br/><span class="small_desc_flat"></span>
