...
<h3>Values</h3> <hr/><span class="member signature apipage">
        ...
        <span class="small_desc_flat"> _no description_ </span><span class="member signature apipage">
            <a name="button_up"><a class="lift" href="#button_up">button\_up</a></a>
        </span>
        <span class="small_desc_flat"> _no description_ </span><span class="member signature apipage">
            <a name="button_down"><a class="lift" href="#button_down">button\_down</a></a>
        </span>
        <span class="small_desc_flat"> _no description_ </span><span class="member signature apipage">
            <a name="axis"><a class="lift" href="#axis">axis</a></a>
        </span>
        <span class="small_desc_flat"> _no description_ </span><span class="member signature apipage">
            <a name="added"><a class="lift" href="#added">added</a></a>
        </span>
        <span class="small_desc_flat"> _no description_ </span><span class="member signature apipage">
            <a name="removed"><a class="lift" href="#removed">removed</a></a>
        </span>
        <span class="small_desc_flat"> _no description_ </span><span class="member signature apipage">
            <a name="remapped"><a class="lift" href="#remapped">remapped</a></a>
        </span>
