...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">typed(me\_type:[Int](http://api.haxe.org/Int.html)<span></span>) : [snow.platform.native.input.sdl.MouseEventType](../../../../../../api/snow/platform/native/input/sdl/MouseEventType.html)</code><br/><span class="small_desc_flat"></span>
