...
`class`extends <code><span>snow.platform.native.input.InputSystem</span></code><br/><span class="meta">
...
<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="destroy"><a class="lift" href="#destroy">destroy</a></a><a data-tooltip="inherited from <a href='../../../../../../api/snow/platform/native/input/InputSystem.html#destroy'>snow.platform.native.input.InputSystem</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
            <code class="signature apipage">destroy() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="gamepad_add"><a class="lift" href="#gamepad_add">gamepad\_add</a></a><a data-tooltip="inherited from <a href='../../../../../../api/snow/platform/native/input/InputSystem.html#gamepad\_add'>snow.platform.native.input.InputSystem</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
            <code class="signature apipage">gamepad\_add(id:[Int](http://api.haxe.org/Int.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="gamepad_remove"><a class="lift" href="#gamepad_remove">gamepad\_remove</a></a><a data-tooltip="inherited from <a href='../../../../../../api/snow/platform/native/input/InputSystem.html#gamepad\_remove'>snow.platform.native.input.InputSystem</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
            <code class="signature apipage">gamepad\_remove(id:[Int](http://api.haxe.org/Int.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="init"><a class="lift" href="#init">init</a></a><a data-tooltip="inherited from <a href='../../../../../../api/snow/platform/native/input/InputSystem.html#init'>snow.platform.native.input.InputSystem</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
...
<span class="method apipage">
            ...
            <code class="signature apipage">new(\_manager:[snow.input.Input](../../../../../../api/snow/input/Input.html)<span></span>, \_lib:[snow.Snow](../../../../../../api/snow/Snow.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="on_event"><a class="lift" href="#on_event">on\_event</a></a><a data-tooltip="inherited from <a href='../../../../../../api/snow/platform/native/input/InputSystem.html#on\_event'>snow.platform.native.input.InputSystem</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
            <code class="signature apipage">on\_event(\_event:[snow.types.InputEvent](../../../../../../api/snow/types/InputEvent.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="process"><a class="lift" href="#process">process</a></a><a data-tooltip="inherited from <a href='../../../../../../api/snow/platform/native/input/InputSystem.html#process'>snow.platform.native.input.InputSystem</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
            <code class="signature apipage">process() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="text_input_rect"><a class="lift" href="#text_input_rect">text\_input\_rect</a></a><a data-tooltip="inherited from <a href='../../../../../../api/snow/platform/native/input/InputSystem.html#text\_input\_rect'>snow.platform.native.input.InputSystem</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
            <code class="signature apipage">text\_input\_rect(x:[Int](http://api.haxe.org/Int.html)<span></span>, y:[Int](http://api.haxe.org/Int.html)<span></span>, w:[Int](http://api.haxe.org/Int.html)<span></span>, h:[Int](http://api.haxe.org/Int.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">In a system text input state, this determines the area that is accepting input.</span>


</span>
<span class="method apipage">
            <a name="text_input_start"><a class="lift" href="#text_input_start">text\_input\_start</a></a><a data-tooltip="inherited from <a href='../../../../../../api/snow/platform/native/input/InputSystem.html#text\_input\_start'>snow.platform.native.input.InputSystem</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
            <code class="signature apipage">text\_input\_start() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Start a system text input state, this includes soft keyboard on mobile. on some platforms like web this does nothing (yet?)</span>


</span>
<span class="method apipage">
            <a name="text_input_stop"><a class="lift" href="#text_input_stop">text\_input\_stop</a></a><a data-tooltip="inherited from <a href='../../../../../../api/snow/platform/native/input/InputSystem.html#text\_input\_stop'>snow.platform.native.input.InputSystem</a>" class="tooltip inherited">&gt;</a><div class="clear"></div>
            <code class="signature apipage">text\_input\_stop() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">End a system text input state, this includes soft keyboard on mobile. on some platforms like web this does nothing (yet?)</span>
