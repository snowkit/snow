...
`class`extends <code><span>snow.assets.Asset</span></code><br/><span class="meta">
meta: @:keep</span>
...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">audio : [snow.types.AudioInfo](../../../api/snow/types/AudioInfo.html)</code><br/></span>
            <span class="small_desc_flat">The `AudioInfo` this asset contains</span><br/><span class="member apipage">
                <a name="format"><a class="lift" href="#format">format</a></a><div class="clear"></div>
                <code class="signature apipage">format : [snow.types.AudioFormatType](../../../api/snow/types/AudioFormatType.html)</code><br/></span>
            <span class="small_desc_flat">The audio format of this asset</span><br/><span class="member apipage">
                <a name="load_full"><a class="lift" href="#load_full">load\_full</a></a><div class="clear"></div>
                <code class="signature apipage">load\_full : [Bool](http://api.haxe.org/Bool.html)</code><br/></span>
            <span class="small_desc_flat">Whether or not this asset is to be loaded in full (or alternatively, streamed). Used from `load` only.</span><br/>


<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="load"><a class="lift" href="#load">load</a></a><div class="clear"></div>
            <code class="signature apipage">load(onload:[snow.assets.AssetAudio](../../../api/snow/assets/AssetAudio.html)&nbsp;-&gt; [Void](http://api.haxe.org/Void.html)<span>=null</span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Called from `app.assets.audio`, or manually, if reloading the asset data at a later point.
...
<span class="method apipage">
            ...
            <code class="signature apipage">new(\_assets:[snow.assets.Assets](../../../api/snow/assets/Assets.html)<span></span>, \_info:[snow.types.AssetInfo](../../../api/snow/types/AssetInfo.html)<span></span>, \_format:[snow.types.AudioFormatType](../../../api/snow/types/AudioFormatType.html)<span></span>, \_load:[Bool](http://api.haxe.org/Bool.html)<span>=true</span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Created from `app.assets.audio`</span>
