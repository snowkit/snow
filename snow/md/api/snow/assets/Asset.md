...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">The asset manager associated with this asset</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The id of this asset like `assets/image.png`</span><br/><span class="member apipage">
                <a name="info"><a class="lift" href="#info">info</a></a><div class="clear"></div>
                <code class="signature apipage">info : [snow.types.AssetInfo](../../../api/snow/types/AssetInfo.html)</code><br/></span>
            <span class="small_desc_flat">The `AssetInfo` of this asset</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">True if this asset has completely loaded. Only changed through `load` and when load completes</span><br/><span class="member apipage">
                <a name="type"><a class="lift" href="#type">type</a></a><div class="clear"></div>
                <code class="signature apipage">type : [snow.types.AssetType](../../../api/snow/types/AssetType.html)</code><br/></span>
            <span class="small_desc_flat">The concrete type this asset holds (useful when handling as Asset base class)</span><br/>


<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="new"><a class="lift" href="#new">new</a></a><div class="clear"></div>
            <code class="signature apipage">new(\_assets:[snow.assets.Assets](../../../api/snow/assets/Assets.html)<span></span>, \_info:[snow.types.AssetInfo](../../../api/snow/types/AssetInfo.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Called from subclasses, by `app.assets`</span>
