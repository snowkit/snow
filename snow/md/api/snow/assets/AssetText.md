...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">The `String` this asset contains</span><br/>


<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="load"><a class="lift" href="#load">load</a></a><div class="clear"></div>
            <code class="signature apipage">load(onload:[snow.assets.AssetText](../../../api/snow/assets/AssetText.html)&nbsp;-&gt; [Void](http://api.haxe.org/Void.html)<span>=null</span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Called from `app.assets.text`, or manually, if reloading the asset data at a later point.
...
<span class="method apipage">
            ...
            <code class="signature apipage">new(\_assets:[snow.assets.Assets](../../../api/snow/assets/Assets.html)<span></span>, \_info:[snow.types.AssetInfo](../../../api/snow/types/AssetInfo.html)<span></span>, \_async:[Bool](http://api.haxe.org/Bool.html)<span>=false</span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Called from `app.assets.text`</span>
