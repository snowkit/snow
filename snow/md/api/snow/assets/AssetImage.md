...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">components : [Int](http://api.haxe.org/Int.html)</code><br/></span>
            <span class="small_desc_flat">The requested components when loading this image.</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The `ImageInfo` this asset contains</span><br/>


<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="load"><a class="lift" href="#load">load</a></a><div class="clear"></div>
            <code class="signature apipage">load(onload:[snow.assets.AssetImage](../../../api/snow/assets/AssetImage.html)&nbsp;-&gt; [Void](http://api.haxe.org/Void.html)<span>=null</span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Called from `app.assets.image`, or manually, if reloading the asset data at a later point.
            Note this function calls the onload handler in the next frame, so sync code can return.</span>


</span>
<span class="method apipage">
            <a name="load_from_bytes"><a class="lift" href="#load_from_bytes">load\_from\_bytes</a></a><div class="clear"></div>
            <code class="signature apipage">load\_from\_bytes(bytes:[snow.utils.ByteArray](../../../api/snow/utils/ByteArray.html)<span></span>, onload:[snow.assets.AssetImage](../../../api/snow/assets/AssetImage.html)&nbsp;-&gt; [Void](http://api.haxe.org/Void.html)<span>=null</span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Called from `app.assets.image`, or manually, if reloading the asset data at a later point.
            Note this function calls the onload handler in the next frame, so sync code can return.</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">new(\_assets:[snow.assets.Assets](../../../api/snow/assets/Assets.html)<span></span>, \_info:[snow.types.AssetInfo](../../../api/snow/types/AssetInfo.html)<span></span>, \_components:[Int](http://api.haxe.org/Int.html)<span>=4</span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Called from `app.assets`</span>
