...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="async"><a class="lift" href="#async">async</a></a><div class="clear"></div>
                <code class="signature apipage">async : [Bool](http://api.haxe.org/Bool.html)</code><br/></span>
            <span class="small_desc_flat">Whether or not this bytes data will load syncronously. Used in `load` only.</span><br/><span class="member apipage">
                <a name="bytes"><a class="lift" href="#bytes">bytes</a></a><div class="clear"></div>
                <code class="signature apipage">bytes : [snow.utils.ByteArray](../../../api/snow/utils/ByteArray.html)</code><br/></span>
            <span class="small_desc_flat">The `ByteArray` this asset contains</span><br/>


<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="load"><a class="lift" href="#load">load</a></a><div class="clear"></div>
            <code class="signature apipage">load(onload:[snow.assets.AssetBytes](../../../api/snow/assets/AssetBytes.html)&nbsp;-&gt; [Void](http://api.haxe.org/Void.html)<span>=null</span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Called from `app.assets.bytes`, or manually, if reloading the asset data at a later point.
...
<span class="method apipage">
            ...
            <code class="signature apipage">new(\_assets:[snow.assets.Assets](../../../api/snow/assets/Assets.html)<span></span>, \_info:[snow.types.AssetInfo](../../../api/snow/types/AssetInfo.html)<span></span>, \_async:[Bool](http://api.haxe.org/Bool.html)<span>=false</span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Called from `app.assets`</span>
