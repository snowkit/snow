...
<h1>AssetJSON</h1>
<small>`snow.types.AssetJSON`</small>



<hr/>

`typedef`&nbsp;alias of `snow.system.assets.AssetJSON`   
<br/><span class="meta">
meta: @:keep</span>
...
<h3>Properties</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">json : [Dynamic](#)</code><br/></span>
            <span class="small_desc_flat">The json data stored in the asset</span>

<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="load"><a class="lift" href="#load">load</a></a><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">load(\_system:[snow.system.assets.Assets](../../../api/snow/system/assets/Assets.html)<span></span>, \_id:[String](http://api.haxe.org/String.html)<span></span>) : [snow.api.Promise](../../../api/snow/api/Promise.html)</code><br/><span class="small_desc_flat">Create a new AssetJSON from an id, which returns a promise for the asset.</span>


</span>
<span class="method apipage">
            <a name="new"><a class="lift" href="#new">new</a></a><div class="clear"></div>
            <code class="signature apipage">new(\_system:[snow.system.assets.Assets](../../../api/snow/system/assets/Assets.html)<span></span>, \_id:[String](http://api.haxe.org/String.html)<span></span>, \_json:[Dynamic](#)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">processor(\_app:[snow.Snow](../../../api/snow/Snow.html)<span></span>, \_id:[String](http://api.haxe.org/String.html)<span></span>, \_data:[snow.api.buffers.Uint8Array](../../../api/snow/api/buffers/Uint8Array.html)<span></span>) : [snow.api.Promise](../../../api/snow/api/Promise.html)</code><br/><span class="small_desc_flat">A default json processor for the data processor API</span>


</span>
<span class="method apipage">
            <a name="reload"><a class="lift" href="#reload">reload</a></a><div class="clear"></div>
            <code class="signature apipage">reload() : [snow.api.Promise](../../../api/snow/api/Promise.html)</code><br/><span class="small_desc_flat">Reloads the json from it's stored id, returning a promise for the asset.</span>
