...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">type : [Null](http://api.haxe.org/Null.html)&lt;[snow.types.FileEventType](../../../api/snow/types/FileEventType.html)&gt;</code><br/></span>
            <span class="small_desc_flat">The type of file watch event, modify/create/delete. Use FileEventType</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The time in seconds when this event was fired</span><br/><span class="member apipage">
                <a name="path"><a class="lift" href="#path">path</a></a><div class="clear"></div>
                <code class="signature apipage">path : [Null](http://api.haxe.org/Null.html)&lt;[String](http://api.haxe.org/String.html)&gt;</code><br/></span>
            <span class="small_desc_flat">The absolute path that was notifying</span><br/>
