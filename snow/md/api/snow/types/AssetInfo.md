...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">type : [String](http://api.haxe.org/String.html)</code><br/></span>
            <span class="small_desc_flat">a convenience type indicator</span><br/><span class="member apipage">
                <a name="path"><a class="lift" href="#path">path</a></a><div class="clear"></div>
                <code class="signature apipage">path : [String](http://api.haxe.org/String.html)</code><br/></span>
            <span class="small_desc_flat">the location of the asset</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">the asset id</span><br/><span class="member apipage">
                <a name="ext"><a class="lift" href="#ext">ext</a></a><div class="clear"></div>
                <code class="signature apipage">ext : [String](http://api.haxe.org/String.html)</code><br/></span>
            <span class="small_desc_flat">the asset extension, if any</span><br/>
