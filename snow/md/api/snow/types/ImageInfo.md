...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">The actual width, used when image is automatically padded to POT</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">image width from source image</span><br/><span class="member apipage">
                <a name="pixels"><a class="lift" href="#pixels">pixels</a></a><div class="clear"></div>
                <code class="signature apipage">pixels : [snow.api.buffers.Uint8Array](../../../api/snow/api/buffers/Uint8Array.html)</code><br/></span>
            <span class="small_desc_flat">image pixel data</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">source asset id</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">The actual height, used when image is automatically padded to POT</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">image height from source image</span><br/><span class="member apipage">
                <a name="bpp_source"><a class="lift" href="#bpp_source">bpp\_source</a></a><div class="clear"></div>
                <code class="signature apipage">bpp\_source : [Int](http://api.haxe.org/Int.html)</code><br/></span>
            <span class="small_desc_flat">source bits per pixel</span><br/><span class="member apipage">
                <a name="bpp"><a class="lift" href="#bpp">bpp</a></a><div class="clear"></div>
                <code class="signature apipage">bpp : [Int](http://api.haxe.org/Int.html)</code><br/></span>
            <span class="small_desc_flat">used bits per pixel</span><br/>
