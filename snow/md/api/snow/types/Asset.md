...
`typedef`&nbsp;alias of `snow.system.assets.Asset`   
...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">The id of this asset, i.e `assets/image.png`</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">True if this asset has completely loaded.</span><br/><span class="member apipage">
                <a name="system"><a class="lift" href="#system">system</a></a><div class="clear"></div>
                <code class="signature apipage">system : [snow.system.assets.Assets](../../../api/snow/system/assets/Assets.html)</code><br/></span>
            <span class="small_desc_flat">The asset system</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">type : [Int](http://api.haxe.org/Int.html)</code><br/></span>
            <span class="small_desc_flat">A convenience type id when dealing with the base class.
            This is an Int because it can be any number for custom types,
            by default uses AssetType for the base types.</span><br/>


<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="destroy"><a class="lift" href="#destroy">destroy</a></a><div class="clear"></div>
            <code class="signature apipage">destroy() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Implemented by subclasses to clean up their data and references.</span>


</span>
<span class="method apipage">
            <a name="new"><a class="lift" href="#new">new</a></a><div class="clear"></div>
            <code class="signature apipage">new(\_system:[snow.system.assets.Assets](../../../api/snow/system/assets/Assets.html)<span></span>, \_id:[String](http://api.haxe.org/String.html)<span></span>, \_type:[Int](http://api.haxe.org/Int.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat">Called from subclasses, by `app.assets`</span>
