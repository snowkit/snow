...
<h3>Values</h3> <hr/><span class="member signature apipage">
        ...
        <span class="small_desc_flat"> An unknown watch event </span><span class="member signature apipage">
            <a name="modify"><a class="lift" href="#modify">modify</a></a>
        </span>
        <span class="small_desc_flat"> An event for when the a file is modified </span><span class="member signature apipage">
            <a name="remove"><a class="lift" href="#remove">remove</a></a>
        </span>
        <span class="small_desc_flat"> An event for when the a file is removed </span><span class="member signature apipage">
            <a name="create"><a class="lift" href="#create">create</a></a>
        </span>
        <span class="small_desc_flat"> An event for when the a file is created </span><span class="member signature apipage">
            <a name="drop"><a class="lift" href="#drop">drop</a></a>
        </span>
