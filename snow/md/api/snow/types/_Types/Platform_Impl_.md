...
<h1>Platform_Impl_</h1>
<small>`snow.types._Types.Platform_Impl_`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="platform_android"><a class="lift" href="#platform_android">platform\_android</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">platform\_android : [snow.types.Platform](../../../../api/snow/types/Platform.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="platform_ios"><a class="lift" href="#platform_ios">platform\_ios</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">platform\_ios : [snow.types.Platform](../../../../api/snow/types/Platform.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="platform_linux"><a class="lift" href="#platform_linux">platform\_linux</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">platform\_linux : [snow.types.Platform](../../../../api/snow/types/Platform.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="platform_mac"><a class="lift" href="#platform_mac">platform\_mac</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">platform\_mac : [snow.types.Platform](../../../../api/snow/types/Platform.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="platform_web"><a class="lift" href="#platform_web">platform\_web</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">platform\_web : [snow.types.Platform](../../../../api/snow/types/Platform.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="platform_windows"><a class="lift" href="#platform_windows">platform\_windows</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">platform\_windows : [snow.types.Platform](../../../../api/snow/types/Platform.html)</code><br/></span>
