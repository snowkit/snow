...
<h1>OpenGLProfile_Impl_</h1>
<small>`snow.types._Types.OpenGLProfile_Impl_`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="compatibility"><a class="lift" href="#compatibility">compatibility</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">compatibility : [snow.types.OpenGLProfile](../../../../api/snow/types/OpenGLProfile.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="core"><a class="lift" href="#core">core</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">core : [snow.types.OpenGLProfile](../../../../api/snow/types/OpenGLProfile.html)</code><br/></span>
