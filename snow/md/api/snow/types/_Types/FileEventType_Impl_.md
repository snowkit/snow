...
<h1>FileEventType_Impl_</h1>
<small>`snow.types._Types.FileEventType_Impl_`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">create : [snow.types.FileEventType](../../../../api/snow/types/FileEventType.html)</code><br/></span>
            <span class="small_desc_flat">An event for when the a file is created</span><br/><span class="member apipage">
                <a name="drop"><a class="lift" href="#drop">drop</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">drop : [snow.types.FileEventType](../../../../api/snow/types/FileEventType.html)</code><br/></span>
            <span class="small_desc_flat">An event for when the a file is dropped on a window</span><br/><span class="member apipage">
                <a name="modify"><a class="lift" href="#modify">modify</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">modify : [snow.types.FileEventType](../../../../api/snow/types/FileEventType.html)</code><br/></span>
            <span class="small_desc_flat">An event for when the a file is modified</span><br/><span class="member apipage">
                <a name="remove"><a class="lift" href="#remove">remove</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">remove : [snow.types.FileEventType](../../../../api/snow/types/FileEventType.html)</code><br/></span>
            <span class="small_desc_flat">An event for when the a file is removed</span><br/><span class="member apipage">
                <a name="unknown"><a class="lift" href="#unknown">unknown</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">unknown : [snow.types.FileEventType](../../../../api/snow/types/FileEventType.html)</code><br/></span>
            <span class="small_desc_flat">An unknown watch event</span><br/>
