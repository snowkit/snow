...
<h1>TextEventType_Impl_</h1>
<small>`snow.types._Types.TextEventType_Impl_`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="edit"><a class="lift" href="#edit">edit</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">edit : [snow.types.TextEventType](../../../../api/snow/types/TextEventType.html)</code><br/></span>
            <span class="small_desc_flat">An edit text typing event</span><br/><span class="member apipage">
                <a name="input"><a class="lift" href="#input">input</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">input : [snow.types.TextEventType](../../../../api/snow/types/TextEventType.html)</code><br/></span>
            <span class="small_desc_flat">An input text typing event</span><br/><span class="member apipage">
                <a name="unknown"><a class="lift" href="#unknown">unknown</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">unknown : [snow.types.TextEventType](../../../../api/snow/types/TextEventType.html)</code><br/></span>
            <span class="small_desc_flat">An unknown text event</span><br/>
