...
<h1>InputEventType_Impl_</h1>
<small>`snow.types._Types.InputEventType_Impl_`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="controller"><a class="lift" href="#controller">controller</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">controller : [snow.types.InputEventType](../../../../api/snow/types/InputEventType.html)</code><br/></span>
            <span class="small_desc_flat">An controller input event. Use these instead of joystick on desktop.</span><br/><span class="member apipage">
                <a name="joystick"><a class="lift" href="#joystick">joystick</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">joystick : [snow.types.InputEventType](../../../../api/snow/types/InputEventType.html)</code><br/></span>
            <span class="small_desc_flat">An joystick input event. On mobile, accellerometer is a joystick (for now)</span><br/><span class="member apipage">
                <a name="key"><a class="lift" href="#key">key</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">key : [snow.types.InputEventType](../../../../api/snow/types/InputEventType.html)</code><br/></span>
            <span class="small_desc_flat">An keyboard input event</span><br/><span class="member apipage">
                <a name="mouse"><a class="lift" href="#mouse">mouse</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">mouse : [snow.types.InputEventType](../../../../api/snow/types/InputEventType.html)</code><br/></span>
            <span class="small_desc_flat">An mouse input event</span><br/><span class="member apipage">
                <a name="touch"><a class="lift" href="#touch">touch</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">touch : [snow.types.InputEventType](../../../../api/snow/types/InputEventType.html)</code><br/></span>
            <span class="small_desc_flat">An touch input event</span><br/><span class="member apipage">
                <a name="unknown"><a class="lift" href="#unknown">unknown</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">unknown : [snow.types.InputEventType](../../../../api/snow/types/InputEventType.html)</code><br/></span>
            <span class="small_desc_flat">An unknown input event</span><br/>
