...
<h1>AudioFormatType_Impl_</h1>
<small>`snow.types._Types.AudioFormatType_Impl_`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="ogg"><a class="lift" href="#ogg">ogg</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">ogg : [snow.types.AudioFormatType](../../../../api/snow/types/AudioFormatType.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="pcm"><a class="lift" href="#pcm">pcm</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">pcm : [snow.types.AudioFormatType](../../../../api/snow/types/AudioFormatType.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="unknown"><a class="lift" href="#unknown">unknown</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">unknown : [snow.types.AudioFormatType](../../../../api/snow/types/AudioFormatType.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="wav"><a class="lift" href="#wav">wav</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">wav : [snow.types.AudioFormatType](../../../../api/snow/types/AudioFormatType.html)</code><br/></span>
