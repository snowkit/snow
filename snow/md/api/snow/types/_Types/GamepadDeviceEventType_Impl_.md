...
<h1>GamepadDeviceEventType_Impl_</h1>
<small>`snow.types._Types.GamepadDeviceEventType_Impl_`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="device_added"><a class="lift" href="#device_added">device\_added</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">device\_added : [snow.types.GamepadDeviceEventType](../../../../api/snow/types/GamepadDeviceEventType.html)</code><br/></span>
            <span class="small_desc_flat">A device added event</span><br/><span class="member apipage">
                <a name="device_remapped"><a class="lift" href="#device_remapped">device\_remapped</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">device\_remapped : [snow.types.GamepadDeviceEventType](../../../../api/snow/types/GamepadDeviceEventType.html)</code><br/></span>
            <span class="small_desc_flat">A device was remapped</span><br/><span class="member apipage">
                <a name="device_removed"><a class="lift" href="#device_removed">device\_removed</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">device\_removed : [snow.types.GamepadDeviceEventType](../../../../api/snow/types/GamepadDeviceEventType.html)</code><br/></span>
            <span class="small_desc_flat">A device removed event</span><br/><span class="member apipage">
                <a name="unknown"><a class="lift" href="#unknown">unknown</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">unknown : [snow.types.GamepadDeviceEventType](../../../../api/snow/types/GamepadDeviceEventType.html)</code><br/></span>
            <span class="small_desc_flat">A unknown device event</span><br/>
