...
<h1>OS_Impl_</h1>
<small>`snow.types._Types.OS_Impl_`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="os_android"><a class="lift" href="#os_android">os\_android</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">os\_android : [snow.types.OS](../../../../api/snow/types/OS.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="os_ios"><a class="lift" href="#os_ios">os\_ios</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">os\_ios : [snow.types.OS](../../../../api/snow/types/OS.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="os_linux"><a class="lift" href="#os_linux">os\_linux</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">os\_linux : [snow.types.OS](../../../../api/snow/types/OS.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="os_mac"><a class="lift" href="#os_mac">os\_mac</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">os\_mac : [snow.types.OS](../../../../api/snow/types/OS.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="os_windows"><a class="lift" href="#os_windows">os\_windows</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">os\_windows : [snow.types.OS](../../../../api/snow/types/OS.html)</code><br/></span>
