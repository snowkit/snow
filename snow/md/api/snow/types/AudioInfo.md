...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">file source id</span><br/><span class="member apipage">
                <a name="handle"><a class="lift" href="#handle">handle</a></a><div class="clear"></div>
                <code class="signature apipage">handle : [snow.types.AudioHandle](../../../api/snow/types/AudioHandle.html)</code><br/></span>
            <span class="small_desc_flat">the platform audio handle for later manipulation</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">format</span><br/><span class="member apipage">
                <a name="data"><a class="lift" href="#data">data</a></a><div class="clear"></div>
                <code class="signature apipage">data : [snow.types.AudioDataInfo](../../../api/snow/types/AudioDataInfo.html)</code><br/></span>
            <span class="small_desc_flat">the platform audio data info</span><br/>
