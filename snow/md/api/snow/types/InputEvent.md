...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">The window id from which this event originated</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">type : [Null](http://api.haxe.org/Null.html)&lt;[snow.types.InputEventType](../../../api/snow/types/InputEventType.html)&gt;</code><br/></span>
            <span class="small_desc_flat">The type of input event this was. Use InputEventType</span><br/><span class="member apipage">
