...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">whether or not the core should run a loop at all, default: true</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">config\_runtime\_path : [String](http://api.haxe.org/String.html)</code><br/></span>
            ...
            <span class="small_desc_flat">If set, no default asset list will be loaded (use `App.config` to load a config manually). default: false</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">config\_assets\_path : [String](http://api.haxe.org/String.html)</code><br/></span>
            <span class="small_desc_flat">The default place to find the asset manifest file, default: `manifest`</span><br/>
