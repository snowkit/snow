...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="has_loop"><a class="lift" href="#has_loop">has\_loop</a></a><div class="clear"></div>
                <code class="signature apipage">has\_loop : [Null](http://api.haxe.org/Null.html)&lt;[Bool](http://api.haxe.org/Bool.html)&gt;</code><br/></span>
            <span class="small_desc_flat">whether or not the core should run a loop at all, default: true</span><br/><span class="member apipage">
                <a name="config_runtime_path"><a class="lift" href="#config_runtime_path">config\_runtime\_path</a></a><div class="clear"></div>
                <code class="signature apipage">config\_runtime\_path : [Null](http://api.haxe.org/Null.html)&lt;[String](http://api.haxe.org/String.html)&gt;</code><br/></span>
            <span class="small_desc_flat">The default place to find the runtime config file, default: `config.json`</span><br/><span class="member apipage">
                <a name="config_custom_runtime"><a class="lift" href="#config_custom_runtime">config\_custom\_runtime</a></a><div class="clear"></div>
                <code class="signature apipage">config\_custom\_runtime : [Null](http://api.haxe.org/Null.html)&lt;[Bool](http://api.haxe.org/Bool.html)&gt;</code><br/></span>
            <span class="small_desc_flat">If set, no default runtime config will be loaded (use `App.config` to load a config manually). default: false</span><br/><span class="member apipage">
                <a name="config_custom_assets"><a class="lift" href="#config_custom_assets">config\_custom\_assets</a></a><div class="clear"></div>
                <code class="signature apipage">config\_custom\_assets : [Null](http://api.haxe.org/Null.html)&lt;[Bool](http://api.haxe.org/Bool.html)&gt;</code><br/></span>
            <span class="small_desc_flat">If set, no default asset list will be loaded (use `App.config` to load a config manually). default: false</span><br/><span class="member apipage">
                <a name="config_assets_path"><a class="lift" href="#config_assets_path">config\_assets\_path</a></a><div class="clear"></div>
                <code class="signature apipage">config\_assets\_path : [Null](http://api.haxe.org/Null.html)&lt;[String](http://api.haxe.org/String.html)&gt;</code><br/></span>
            <span class="small_desc_flat">The default place to find the asset manifest file, default: `manifest`</span><br/><span class="member apipage">
                <a name="app_package"><a class="lift" href="#app_package">app\_package</a></a><div class="clear"></div>
                <code class="signature apipage">app\_package : [Null](http://api.haxe.org/Null.html)&lt;[String](http://api.haxe.org/String.html)&gt;</code><br/></span>
            <span class="small_desc_flat">The application specific package. i.e org.snowkit.snowapp
