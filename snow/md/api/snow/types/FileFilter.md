...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="extension"><a class="lift" href="#extension">extension</a></a><div class="clear"></div>
                <code class="signature apipage">extension : [String](http://api.haxe.org/String.html)</code><br/></span>
            <span class="small_desc_flat">An extension for the filter. i.e `md`, `txt`, `png` or a special `*` for any file type.</span><br/><span class="member apipage">
                <a name="desc"><a class="lift" href="#desc">desc</a></a><div class="clear"></div>
                <code class="signature apipage">desc : [Null](http://api.haxe.org/Null.html)&lt;[String](http://api.haxe.org/String.html)&gt;</code><br/></span>
            <span class="small_desc_flat">An optional description for this filter i.e `markdown files`, `text files`, `all files`</span><br/>
