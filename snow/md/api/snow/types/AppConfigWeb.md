...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="true_fullscreen"><a class="lift" href="#true_fullscreen">true\_fullscreen</a></a><div class="clear"></div>
                <code class="signature apipage">true\_fullscreen : [Null](http://api.haxe.org/Null.html)&lt;[Bool](http://api.haxe.org/Bool.html)&gt;</code><br/></span>
            <span class="small_desc_flat">If true, native fullscreen will be requested from the user.
            ...
            You cannot force fullscreen on web. default: false</span><br/><span class="member apipage">
                <a name="prevent_default_mouse_wheel"><a class="lift" href="#prevent_default_mouse_wheel">prevent\_default\_mouse\_wheel</a></a><div class="clear"></div>
                <code class="signature apipage">prevent\_default\_mouse\_wheel : [Null](http://api.haxe.org/Null.html)&lt;[Bool](http://api.haxe.org/Bool.html)&gt;</code><br/></span>
            <span class="small_desc_flat">If true, mouse wheel events sent to the page will be consumed by snow. `event.preventDefault` is used. default: true</span><br/><span class="member apipage">
                <a name="prevent_default_keys"><a class="lift" href="#prevent_default_keys">prevent\_default\_keys</a></a><div class="clear"></div>
                <code class="signature apipage">prevent\_default\_keys : [Null](http://api.haxe.org/Null.html)&lt;[Array](http://api.haxe.org/Array.html)&gt;</code><br/></span>
            <span class="small_desc_flat">Any Key.* values stored in this array sent to the page will be consumed by snow. `event.preventDefault` is used.
            Keys can be removed or added to the array at runtime. default:left,up,down,right,backspace,tab,delete</span><br/><span class="member apipage">
                <a name="no_context_menu"><a class="lift" href="#no_context_menu">no\_context\_menu</a></a><div class="clear"></div>
                <code class="signature apipage">no\_context\_menu : [Null](http://api.haxe.org/Null.html)&lt;[Bool](http://api.haxe.org/Bool.html)&gt;</code><br/></span>
            <span class="small_desc_flat">If true, right clicking will consume the event on the canvas. `event.preventDefault` is used. default: true</span><br/>
