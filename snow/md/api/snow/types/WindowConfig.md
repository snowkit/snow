...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">window width at creation, default: 960</span><br/><span class="member apipage">
                <a name="title"><a class="lift" href="#title">title</a></a><div class="clear"></div>
                <code class="signature apipage">title : [Null](http://api.haxe.org/Null.html)&lt;[String](http://api.haxe.org/String.html)&gt;</code><br/></span>
            ...
            <span class="small_desc_flat">window height at creation, default: 640</span><br/><span class="member apipage">
                <a name="fullscreen_desktop"><a class="lift" href="#fullscreen_desktop">fullscreen\_desktop</a></a><div class="clear"></div>
                <code class="signature apipage">fullscreen\_desktop : [Null](http://api.haxe.org/Null.html)&lt;[Bool](http://api.haxe.org/Bool.html)&gt;</code><br/></span>
            <span class="small_desc_flat">If true, the users native desktop resolution will be used for fullscreen instead of the specified window size. default: true</span><br/><span class="member apipage">
            ...
            <span class="small_desc_flat">create as a borderless window, default: false</span><br/>
