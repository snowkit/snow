...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">If type is `window` this will be populated, otherwise null</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">type : [snow.types.SystemEventType](../../../api/snow/types/SystemEventType.html)</code><br/></span>
            <span class="small_desc_flat">The type of system event this event is.</span><br/><span class="member apipage">
