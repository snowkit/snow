...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">window : [Null](http://api.haxe.org/Null.html)&lt;[snow.types.WindowEvent](../../../api/snow/types/WindowEvent.html)&gt;</code><br/></span>
            <span class="small_desc_flat">If type is `window` this will be populated, otherwise null</span><br/><span class="member apipage">
                <a name="type"><a class="lift" href="#type">type</a></a><div class="clear"></div>
                <code class="signature apipage">type : [Null](http://api.haxe.org/Null.html)&lt;[snow.types.SystemEventType](../../../api/snow/types/SystemEventType.html)&gt;</code><br/></span>
            <span class="small_desc_flat">The type of system event this event is. SystemEventType</span><br/><span class="member apipage">
                <a name="input"><a class="lift" href="#input">input</a></a><div class="clear"></div>
                <code class="signature apipage">input : [Null](http://api.haxe.org/Null.html)&lt;[snow.types.InputEvent](../../../api/snow/types/InputEvent.html)&gt;</code><br/></span>
            <span class="small_desc_flat">If type is `input` this will be populated, otherwise null</span><br/><span class="member apipage">
                <a name="file"><a class="lift" href="#file">file</a></a><div class="clear"></div>
                <code class="signature apipage">file : [Null](http://api.haxe.org/Null.html)&lt;[snow.types.FileEvent](../../../api/snow/types/FileEvent.html)&gt;</code><br/></span>
            <span class="small_desc_flat">If type is `file` this will be populated, otherwise null</span><br/>
