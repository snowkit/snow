...
<h1>IODataOptions</h1>
<small>`snow.types.IODataOptions`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="binary"><a class="lift" href="#binary">binary</a></a><div class="clear"></div>
                <code class="signature apipage">binary : [Null](http://api.haxe.org/Null.html)&lt;[Bool](http://api.haxe.org/Bool.html)&gt;</code><br/></span>
