...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">window : [Null](http://api.haxe.org/Null.html)&lt;[snow.types.WindowConfig](../../../api/snow/types/WindowConfig.html)&gt;</code><br/></span>
            <span class="small_desc_flat">the window config for the default window, if `has_window` is true. default: see `WindowConfig` docs</span><br/><span class="member apipage">
                <a name="web"><a class="lift" href="#web">web</a></a><div class="clear"></div>
                <code class="signature apipage">web : [Null](http://api.haxe.org/Null.html)&lt;[snow.types.AppConfigWeb](../../../api/snow/types/AppConfigWeb.html)&gt;</code><br/></span>
            <span class="small_desc_flat">config specific to the web target</span><br/><span class="member apipage">
                <a name="runtime"><a class="lift" href="#runtime">runtime</a></a><div class="clear"></div>
                <code class="signature apipage">runtime : [Null](http://api.haxe.org/Null.html)&lt;[](#)&gt;</code><br/></span>
            <span class="small_desc_flat">the user specific config, by default, read from a json file at runtime</span><br/><span class="member apipage">
                <a name="render"><a class="lift" href="#render">render</a></a><div class="clear"></div>
                <code class="signature apipage">render : [Null](http://api.haxe.org/Null.html)&lt;[snow.types.RenderConfig](../../../api/snow/types/RenderConfig.html)&gt;</code><br/></span>
            <span class="small_desc_flat">The render config that specifies rendering and context backend specifics.</span><br/><span class="member apipage">
                <a name="native"><a class="lift" href="#native">native</a></a><div class="clear"></div>
                <code class="signature apipage">native : [Null](http://api.haxe.org/Null.html)&lt;[snow.types.AppConfigNative](../../../api/snow/types/AppConfigNative.html)&gt;</code><br/></span>
            <span class="small_desc_flat">config specific to the native target</span><br/><span class="member apipage">
                <a name="has_window"><a class="lift" href="#has_window">has\_window</a></a><div class="clear"></div>
                <code class="signature apipage">has\_window : [Null](http://api.haxe.org/Null.html)&lt;[Bool](http://api.haxe.org/Bool.html)&gt;</code><br/></span>
            <span class="small_desc_flat">whether or not to create and run a default window, default: true</span><br/>
