...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">config specific to the web target</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">runtime : [Dynamic](#)</code><br/></span>
            ...
            <span class="small_desc_flat">whether or not to create and run a default window, default: true</span><br/><span class="member apipage">
                <a name="assets"><a class="lift" href="#assets">assets</a></a><div class="clear"></div>
                <code class="signature apipage">assets : [Array](http://api.haxe.org/Array.html)&lt;[snow.types.AssetInfo](../../../api/snow/types/AssetInfo.html)&gt;</code><br/></span>
            <span class="small_desc_flat">the raw list of assets. use the app.assets from Snow for access to these. read from a manifest file by default</span><br/>
