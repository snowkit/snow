...
<h3>Values</h3> <hr/><span class="member signature apipage">
        ...
        <span class="small_desc_flat"> An unknown input event </span><span class="member signature apipage">
            <a name="key"><a class="lift" href="#key">key</a></a>
        </span>
        <span class="small_desc_flat"> An keyboard input event </span><span class="member signature apipage">
            <a name="mouse"><a class="lift" href="#mouse">mouse</a></a>
        </span>
        <span class="small_desc_flat"> An mouse input event </span><span class="member signature apipage">
            <a name="touch"><a class="lift" href="#touch">touch</a></a>
        </span>
        <span class="small_desc_flat"> An touch input event </span><span class="member signature apipage">
            <a name="joystick"><a class="lift" href="#joystick">joystick</a></a>
        </span>
        <span class="small_desc_flat"> An joystick input event. On mobile, accellerometer is a joystick (for now) </span><span class="member signature apipage">
            <a name="controller"><a class="lift" href="#controller">controller</a></a>
        </span>
