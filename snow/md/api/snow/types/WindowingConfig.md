...
<h1>WindowingConfig</h1>
<small>`snow.types.WindowingConfig`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="render_config"><a class="lift" href="#render_config">render\_config</a></a><div class="clear"></div>
                <code class="signature apipage">render\_config : [snow.types.RenderConfig](../../../api/snow/types/RenderConfig.html)</code><br/></span>
