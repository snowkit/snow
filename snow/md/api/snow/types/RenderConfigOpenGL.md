...
<h1>RenderConfigOpenGL</h1>
<small>`snow.types.RenderConfigOpenGL`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="profile"><a class="lift" href="#profile">profile</a></a><div class="clear"></div>
                <code class="signature apipage">profile : [Null](http://api.haxe.org/Null.html)&lt;[snow.types.OpenGLProfile](../../../api/snow/types/OpenGLProfile.html)&gt;</code><br/></span>
            <span class="small_desc_flat">The OpenGL context profile to request</span><br/><span class="member apipage">
                <a name="minor"><a class="lift" href="#minor">minor</a></a><div class="clear"></div>
                <code class="signature apipage">minor : [Null](http://api.haxe.org/Null.html)&lt;[Int](http://api.haxe.org/Int.html)&gt;</code><br/></span>
            <span class="small_desc_flat">The minor OpenGL version to request</span><br/><span class="member apipage">
                <a name="major"><a class="lift" href="#major">major</a></a><div class="clear"></div>
                <code class="signature apipage">major : [Null](http://api.haxe.org/Null.html)&lt;[Int](http://api.haxe.org/Int.html)&gt;</code><br/></span>
            <span class="small_desc_flat">The major OpenGL version to request</span><br/>
