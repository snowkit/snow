...
<h1>Audio</h1>
<small>`snow.modules.interfaces.Audio`</small>
...
meta: @:keep, @:noCompletion, @:allow(snow.system.audio.Audio)</span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">create\_sound\_from\_bytes(\_name:[String](http://api.haxe.org/String.html)<span></span>, \_bytes:[snow.api.buffers.Uint8Array](../../../../api/snow/api/buffers/Uint8Array.html)<span></span>, \_format:[snow.types.AudioFormatType](../../../../api/snow/types/AudioFormatType.html)<span></span>) : [snow.system.audio.Sound](../../../../api/snow/system/audio/Sound.html)</code><br/><span class="small_desc_flat"></span>
