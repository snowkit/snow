...
<h1>Audio</h1>
<small>`snow.modules.openal.Audio`</small>

Internal audio system implementation for OpenAL, interact with this system through `snow.Audio`, not directly

<hr/>

`class`extends <code><span>snow.core.native.audio.Audio</span></code><br/><span class="meta">
...
<span class="method apipage">
            ...
            <code class="signature apipage">create\_sound\_from\_bytes(\_name:[String](http://api.haxe.org/String.html)<span></span>, \_bytes:[snow.api.buffers.Uint8Array](../../../../api/snow/api/buffers/Uint8Array.html)<span></span>, \_format:[snow.types.AudioFormatType](../../../../api/snow/types/AudioFormatType.html)<span></span>) : [snow.modules.openal.Sound](../../../../api/snow/modules/openal/Sound.html)</code><br/><span class="small_desc_flat"></span>
