...
<h1>ALStream</h1>
<small>`snow.modules.openal.sound.ALStream`</small>

The openal specifics for a streamed sound

<hr/>

`class`extends <code><span>snow.modules.openal.sound.ALSound</span></code><br/><span class="meta">
...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">remaining buffers to play</span><br/>
