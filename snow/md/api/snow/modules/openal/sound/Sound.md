...
<h1>Sound</h1>
<small>`snow.modules.openal.sound.Sound`</small>
...
`class`extends <code><span>snow.system.audio.Sound</span></code><br/><span class="meta">
meta: @:directlyUsed, @:keep, @:allow(snow.system.audio.Audio), @:allow(snow.modules.openal.Audio), @:allow(snow.modules.openal.sound.ALSound), @:allow(snow.modules.openal.sound.ALStream), @:noCompletion</span>
...
<span class="method apipage">
            <a name="internal_loop"><a class="lift" href="#internal_loop">internal\_loop</a></a><div class="clear"></div>
            <code class="signature apipage">internal\_loop() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            <a name="internal_stop"><a class="lift" href="#internal_stop">internal\_stop</a></a><div class="clear"></div>
            <code class="signature apipage">internal\_stop() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
