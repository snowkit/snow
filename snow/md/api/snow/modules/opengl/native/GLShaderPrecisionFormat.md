...
<small>`snow.modules.opengl.native.GLShaderPrecisionFormat`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="rangeMin"><a class="lift" href="#rangeMin">rangeMin</a></a><div class="clear"></div>
                <code class="signature apipage">rangeMin : [Int](http://api.haxe.org/Int.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="rangeMax"><a class="lift" href="#rangeMax">rangeMax</a></a><div class="clear"></div>
                <code class="signature apipage">rangeMax : [Int](http://api.haxe.org/Int.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="precision"><a class="lift" href="#precision">precision</a></a><div class="clear"></div>
                <code class="signature apipage">precision : [Int](http://api.haxe.org/Int.html)</code><br/></span>
