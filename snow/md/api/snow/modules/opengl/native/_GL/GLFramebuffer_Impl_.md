...
<small>`snow.modules.opengl.native._GL.GLFramebuffer_Impl_`</small>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">\_new(\_id:[Int](http://api.haxe.org/Int.html)<span></span>) : [snow.modules.opengl.native.GLFramebuffer](../../../../../../api/snow/modules/opengl/native/GLFramebuffer.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">fromDynamic(\_id:[Dynamic](#)<span></span>) : [snow.modules.opengl.native.GLFramebuffer](../../../../../../api/snow/modules/opengl/native/GLFramebuffer.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="fromInt"><a class="lift" href="#fromInt">fromInt</a></a><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">fromInt(\_id:[Int](http://api.haxe.org/Int.html)<span></span>) : [snow.modules.opengl.native.GLFramebuffer](../../../../../../api/snow/modules/opengl/native/GLFramebuffer.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">toDynamic(this:[snow.modules.opengl.native.GLFBO](../../../../../../api/snow/modules/opengl/native/GLFBO.html)<span></span>) : [Dynamic](#)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="toInt"><a class="lift" href="#toInt">toInt</a></a><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">toInt(this:[snow.modules.opengl.native.GLFBO](../../../../../../api/snow/modules/opengl/native/GLFBO.html)<span></span>) : [Int](http://api.haxe.org/Int.html)</code><br/><span class="small_desc_flat"></span>
...
<span class="method apipage">
            ...
            <code class="signature apipage">toNullInt(this:[snow.modules.opengl.native.GLFBO](../../../../../../api/snow/modules/opengl/native/GLFBO.html)<span></span>) : [Null](http://api.haxe.org/Null.html)&lt;[Int](http://api.haxe.org/Int.html)&gt;</code><br/><span class="small_desc_flat"></span>
