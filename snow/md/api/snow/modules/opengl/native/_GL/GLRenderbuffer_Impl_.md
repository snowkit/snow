...
<small>`snow.modules.opengl.native._GL.GLRenderbuffer_Impl_`</small>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="_new"><a class="lift" href="#_new">\_new</a></a><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">\_new(\_id:[Int](http://api.haxe.org/Int.html)<span></span>) : [snow.modules.opengl.native.GLRenderbuffer](../../../../../../api/snow/modules/opengl/native/GLRenderbuffer.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="fromDynamic"><a class="lift" href="#fromDynamic">fromDynamic</a></a><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">fromDynamic(\_id:[Dynamic](#)<span></span>) : [snow.modules.opengl.native.GLRenderbuffer](../../../../../../api/snow/modules/opengl/native/GLRenderbuffer.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="fromInt"><a class="lift" href="#fromInt">fromInt</a></a><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">fromInt(\_id:[Int](http://api.haxe.org/Int.html)<span></span>) : [snow.modules.opengl.native.GLRenderbuffer](../../../../../../api/snow/modules/opengl/native/GLRenderbuffer.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="toDynamic"><a class="lift" href="#toDynamic">toDynamic</a></a><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">toDynamic(this:[snow.modules.opengl.native.GLRBO](../../../../../../api/snow/modules/opengl/native/GLRBO.html)<span></span>) : [Dynamic](#)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="toInt"><a class="lift" href="#toInt">toInt</a></a><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">toInt(this:[snow.modules.opengl.native.GLRBO](../../../../../../api/snow/modules/opengl/native/GLRBO.html)<span></span>) : [Int](http://api.haxe.org/Int.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="toNullInt"><a class="lift" href="#toNullInt">toNullInt</a></a><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">toNullInt(this:[snow.modules.opengl.native.GLRBO](../../../../../../api/snow/modules/opengl/native/GLRBO.html)<span></span>) : [Null](http://api.haxe.org/Null.html)&lt;[Int](http://api.haxe.org/Int.html)&gt;</code><br/><span class="small_desc_flat"></span>
