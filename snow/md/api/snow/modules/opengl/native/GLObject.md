...
<h1>GLObject</h1>
<small>`snow.modules.opengl.native.GLObject`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">The native GL handle/id. read only</span><br/>

<h3>Properties</h3> <hr/><span class="member apipage">
                <a name="invalidated"><a class="lift" href="#invalidated">invalidated</a></a><div class="clear"></div>
                <code class="signature apipage">invalidated : [Bool](http://api.haxe.org/Bool.html)</code><br/></span>
