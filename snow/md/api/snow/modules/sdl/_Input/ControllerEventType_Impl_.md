...
<h1>ControllerEventType_Impl_</h1>
<small>`snow.modules.sdl._Input.ControllerEventType_Impl_`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">added : [snow.modules.sdl._Input.ControllerEventType](../../../../../api/snow/modules/sdl/_Input/ControllerEventType.html)</code><br/></span>
            <span class="small_desc_flat">a gamepad connected event</span><br/><span class="member apipage">
                <a name="axis"><a class="lift" href="#axis">axis</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">axis : [snow.modules.sdl._Input.ControllerEventType](../../../../../api/snow/modules/sdl/_Input/ControllerEventType.html)</code><br/></span>
            <span class="small_desc_flat">a gamepad axis movement event</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">button\_down : [snow.modules.sdl._Input.ControllerEventType](../../../../../api/snow/modules/sdl/_Input/ControllerEventType.html)</code><br/></span>
            <span class="small_desc_flat">a gamepad button pressed event</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">button\_up : [snow.modules.sdl._Input.ControllerEventType](../../../../../api/snow/modules/sdl/_Input/ControllerEventType.html)</code><br/></span>
            <span class="small_desc_flat">a gamepad button released event</span><br/><span class="member apipage">
                <a name="remapped"><a class="lift" href="#remapped">remapped</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">remapped : [snow.modules.sdl._Input.ControllerEventType](../../../../../api/snow/modules/sdl/_Input/ControllerEventType.html)</code><br/></span>
            <span class="small_desc_flat">a gamepad remapped event</span><br/><span class="member apipage">
                <a name="removed"><a class="lift" href="#removed">removed</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">removed : [snow.modules.sdl._Input.ControllerEventType](../../../../../api/snow/modules/sdl/_Input/ControllerEventType.html)</code><br/></span>
            <span class="small_desc_flat">a gamepad disconnected event</span><br/>
