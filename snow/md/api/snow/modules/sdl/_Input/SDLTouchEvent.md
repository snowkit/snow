...
<h1>SDLTouchEvent</h1>
<small>`snow.modules.sdl._Input.SDLTouchEvent`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                ...
                <code class="signature apipage">type : [snow.modules.sdl._Input.TouchEventType](../../../../../api/snow/modules/sdl/_Input/TouchEventType.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="finger_id"><a class="lift" href="#finger_id">finger\_id</a></a><div class="clear"></div>
                <code class="signature apipage">finger\_id : [Int](http://api.haxe.org/Int.html)</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="dy"><a class="lift" href="#dy">dy</a></a><div class="clear"></div>
                <code class="signature apipage">dy : [Null](http://api.haxe.org/Null.html)&lt;[Float](http://api.haxe.org/Float.html)&gt;</code><br/></span>
            <span class="small_desc_flat"></span><br/><span class="member apipage">
                <a name="dx"><a class="lift" href="#dx">dx</a></a><div class="clear"></div>
                <code class="signature apipage">dx : [Null](http://api.haxe.org/Null.html)&lt;[Float](http://api.haxe.org/Float.html)&gt;</code><br/></span>
