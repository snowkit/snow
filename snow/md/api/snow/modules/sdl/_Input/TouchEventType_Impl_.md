...
<h1>TouchEventType_Impl_</h1>
<small>`snow.modules.sdl._Input.TouchEventType_Impl_`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">down : [snow.modules.sdl._Input.TouchEventType](../../../../../api/snow/modules/sdl/_Input/TouchEventType.html)</code><br/></span>
            <span class="small_desc_flat">A touch has begun</span><br/><span class="member apipage">
                <a name="move"><a class="lift" href="#move">move</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">move : [snow.modules.sdl._Input.TouchEventType](../../../../../api/snow/modules/sdl/_Input/TouchEventType.html)</code><br/></span>
            <span class="small_desc_flat">A touch is moving</span><br/><span class="member apipage">
                <a name="up"><a class="lift" href="#up">up</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">up : [snow.modules.sdl._Input.TouchEventType](../../../../../api/snow/modules/sdl/_Input/TouchEventType.html)</code><br/></span>
            <span class="small_desc_flat">A touch has ended</span><br/>
