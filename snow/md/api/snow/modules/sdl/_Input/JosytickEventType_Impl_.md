...
<h1>JosytickEventType_Impl_</h1>
<small>`snow.modules.sdl._Input.JosytickEventType_Impl_`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                <a name="added"><a class="lift" href="#added">added</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">added : [snow.modules.sdl._Input.JosytickEventType](../../../../../api/snow/modules/sdl/_Input/JosytickEventType.html)</code><br/></span>
            <span class="small_desc_flat">a joystick connected event</span><br/><span class="member apipage">
                <a name="axis"><a class="lift" href="#axis">axis</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">axis : [snow.modules.sdl._Input.JosytickEventType](../../../../../api/snow/modules/sdl/_Input/JosytickEventType.html)</code><br/></span>
            <span class="small_desc_flat">a joystick axis movement event</span><br/><span class="member apipage">
                <a name="ball"><a class="lift" href="#ball">ball</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">ball : [snow.modules.sdl._Input.JosytickEventType](../../../../../api/snow/modules/sdl/_Input/JosytickEventType.html)</code><br/></span>
            <span class="small_desc_flat">a joystick ball movement event</span><br/><span class="member apipage">
                <a name="button_down"><a class="lift" href="#button_down">button\_down</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">button\_down : [snow.modules.sdl._Input.JosytickEventType](../../../../../api/snow/modules/sdl/_Input/JosytickEventType.html)</code><br/></span>
            <span class="small_desc_flat">a joystick button pressed event</span><br/><span class="member apipage">
                <a name="button_up"><a class="lift" href="#button_up">button\_up</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">button\_up : [snow.modules.sdl._Input.JosytickEventType](../../../../../api/snow/modules/sdl/_Input/JosytickEventType.html)</code><br/></span>
            <span class="small_desc_flat">a joystick button released event</span><br/><span class="member apipage">
                <a name="hat"><a class="lift" href="#hat">hat</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">hat : [snow.modules.sdl._Input.JosytickEventType](../../../../../api/snow/modules/sdl/_Input/JosytickEventType.html)</code><br/></span>
            <span class="small_desc_flat">a joystick hat movement event</span><br/><span class="member apipage">
                <a name="removed"><a class="lift" href="#removed">removed</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">removed : [snow.modules.sdl._Input.JosytickEventType](../../../../../api/snow/modules/sdl/_Input/JosytickEventType.html)</code><br/></span>
            <span class="small_desc_flat">a joystick disconnected event</span><br/>
