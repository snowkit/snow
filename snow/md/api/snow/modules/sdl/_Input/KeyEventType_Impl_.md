...
<h1>KeyEventType_Impl_</h1>
<small>`snow.modules.sdl._Input.KeyEventType_Impl_`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">down : [snow.modules.sdl._Input.KeyEventType](../../../../../api/snow/modules/sdl/_Input/KeyEventType.html)</code><br/></span>
            <span class="small_desc_flat">A key down event</span><br/><span class="member apipage">
                <a name="textedit"><a class="lift" href="#textedit">textedit</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">textedit : [snow.modules.sdl._Input.KeyEventType](../../../../../api/snow/modules/sdl/_Input/KeyEventType.html)</code><br/></span>
            <span class="small_desc_flat">A text input text edit event</span><br/><span class="member apipage">
                <a name="textinput"><a class="lift" href="#textinput">textinput</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">textinput : [snow.modules.sdl._Input.KeyEventType](../../../../../api/snow/modules/sdl/_Input/KeyEventType.html)</code><br/></span>
            <span class="small_desc_flat">A text input typing event</span><br/><span class="member apipage">
                <a name="up"><a class="lift" href="#up">up</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">up : [snow.modules.sdl._Input.KeyEventType](../../../../../api/snow/modules/sdl/_Input/KeyEventType.html)</code><br/></span>
            <span class="small_desc_flat">A key up event</span><br/>
