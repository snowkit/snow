...
<h1>MouseEventType_Impl_</h1>
<small>`snow.modules.sdl._Input.MouseEventType_Impl_`</small>
...
<h3>Members</h3> <hr/><span class="member apipage">
                ...
                <code class="signature apipage">down : [snow.modules.sdl._Input.MouseEventType](../../../../../api/snow/modules/sdl/_Input/MouseEventType.html)</code><br/></span>
            <span class="small_desc_flat">A mouse button pressed event</span><br/><span class="member apipage">
                <a name="move"><a class="lift" href="#move">move</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">move : [snow.modules.sdl._Input.MouseEventType](../../../../../api/snow/modules/sdl/_Input/MouseEventType.html)</code><br/></span>
            <span class="small_desc_flat">A mouse moved event</span><br/><span class="member apipage">
                <a name="up"><a class="lift" href="#up">up</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">up : [snow.modules.sdl._Input.MouseEventType](../../../../../api/snow/modules/sdl/_Input/MouseEventType.html)</code><br/></span>
            <span class="small_desc_flat">A mouse button released event</span><br/><span class="member apipage">
                <a name="wheel"><a class="lift" href="#wheel">wheel</a></a><span class="inline-block static">static</span><div class="clear"></div>
                <code class="signature apipage">wheel : [snow.modules.sdl._Input.MouseEventType](../../../../../api/snow/modules/sdl/_Input/MouseEventType.html)</code><br/></span>
            <span class="small_desc_flat">A mouse wheel or scroll event</span><br/>
