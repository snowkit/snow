...
<span class="method apipage">
            <a name="string_destroy"><a class="lift" href="#string_destroy">string\_destroy</a></a><div class="clear"></div>
            <code class="signature apipage">string\_destroy(\_slot:[Int](http://api.haxe.org/Int.html)<span></span>) : [Bool](http://api.haxe.org/Bool.html)</code><br/><span class="small_desc_flat">Destroy a specific string slot, removing all values stored.
            Does not ask for confirmation. Returns true if successful, false otherwise.</span>
