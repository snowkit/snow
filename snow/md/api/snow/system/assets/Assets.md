...
<h3>Members</h3> <hr/><span class="member apipage">
            ...
            <span class="small_desc_flat">access to snow from subsystems</span><br/><span class="member apipage">
                ...
                <code class="signature apipage">list : [Array](http://api.haxe.org/Array.html)&lt;[String](http://api.haxe.org/String.html)&gt;</code><br/></span>
            <span class="small_desc_flat">The list of assets found in the manifest</span><br/><span class="member apipage">
