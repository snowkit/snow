...
<h1>Input</h1>
<small>`snow.core.native.input.Input`</small>



<hr/>

`class`<br/>implements <code><span>snow.modules.interfaces.Input</span></code><br/><span class="meta">
meta: @:directlyUsed, @:keep, @:allow(snow.system.input.Input)</span>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">text\_input\_rect(x:[Int](http://api.haxe.org/Int.html)<span></span>, y:[Int](http://api.haxe.org/Int.html)<span></span>, w:[Int](http://api.haxe.org/Int.html)<span></span>, h:[Int](http://api.haxe.org/Int.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="text_input_start"><a class="lift" href="#text_input_start">text\_input\_start</a></a><div class="clear"></div>
            <code class="signature apipage">text\_input\_start() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="text_input_stop"><a class="lift" href="#text_input_stop">text\_input\_stop</a></a><div class="clear"></div>
            <code class="signature apipage">text\_input\_stop() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
