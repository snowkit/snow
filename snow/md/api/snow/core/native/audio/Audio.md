...
<h1>Audio</h1>
<small>`snow.core.native.audio.Audio`</small>



<hr/>

`class`<br/>implements <code><span>snow.modules.interfaces.Audio</span></code><br/><span class="meta">
meta: @:keep, @:allow(snow.system.audio.Audio)</span>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="create_sound"><a class="lift" href="#create_sound">create\_sound</a></a><div class="clear"></div>
            <code class="signature apipage">create\_sound(\_id:[String](http://api.haxe.org/String.html)<span></span>, \_name:[String](http://api.haxe.org/String.html)<span></span>, \_streaming:[Bool](http://api.haxe.org/Bool.html)<span></span>, \_format:[snow.types.AudioFormatType](../../../../../api/snow/types/AudioFormatType.html)<span></span>) : [snow.api.Promise](../../../../../api/snow/api/Promise.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="create_sound_from_bytes"><a class="lift" href="#create_sound_from_bytes">create\_sound\_from\_bytes</a></a><div class="clear"></div>
            <code class="signature apipage">create\_sound\_from\_bytes(\_name:[String](http://api.haxe.org/String.html)<span></span>, \_bytes:[snow.api.buffers.Uint8Array](../../../../../api/snow/api/buffers/Uint8Array.html)<span></span>, \_format:[snow.types.AudioFormatType](../../../../../api/snow/types/AudioFormatType.html)<span></span>) : [snow.core.native.audio.Sound](../../../../../api/snow/core/native/audio/Sound.html)</code><br/><span class="small_desc_flat"></span>
