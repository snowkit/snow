...
<h1>PSD</h1>
<small>`snow.core.web.assets.psd.PSD`</small>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            ...
            <code class="signature apipage">new(\_bytes:[snow.api.buffers.Uint8Array](../../../../../../api/snow/api/buffers/Uint8Array.html)<span></span>) : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>


</span>
<span class="method apipage">
            <a name="parse"><a class="lift" href="#parse">parse</a></a><div class="clear"></div>
            <code class="signature apipage">parse() : [Void](http://api.haxe.org/Void.html)</code><br/><span class="small_desc_flat"></span>
