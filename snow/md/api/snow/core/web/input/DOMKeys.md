...
<h1>DOMKeys</h1>
<small>`snow.core.web.input.DOMKeys`</small>
...
<h3>Methods</h3> <hr/><span class="method apipage">
            <a name="dom_key_to_keycode"><a class="lift" href="#dom_key_to_keycode">dom\_key\_to\_keycode</a></a><span class="inline-block static">static</span><div class="clear"></div>
            <code class="signature apipage">dom\_key\_to\_keycode(\_keycode:[Int](http://api.haxe.org/Int.html)<span></span>) : [Int](http://api.haxe.org/Int.html)</code><br/><span class="small_desc_flat">This function takes the DOM keycode and translates it into the
            corresponding snow Keycodes value - but only if needed for special cases</span>
