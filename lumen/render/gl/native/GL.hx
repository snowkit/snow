package lumen.render.gl.native;
...
class GL {
    ...
    static var lumen_gl_bind_buffer = load("lumen_gl_bind_buffer", 2);
    static var lumen_gl_bind_framebuffer = load("lumen_gl_bind_framebuffer", 2);
    static var lumen_gl_bind_renderbuffer = load("lumen_gl_bind_renderbuffer", 2);
    static var lumen_gl_bind_texture = load("lumen_gl_bind_texture", 2);
    static var lumen_gl_blend_color = load("lumen_gl_blend_color", 4);
    static var lumen_gl_blend_equation = load("lumen_gl_blend_equation", 1);
    static var lumen_gl_blend_equation_separate = load("lumen_gl_blend_equation_separate", 2);
    static var lumen_gl_blend_func = load("lumen_gl_blend_func", 2);
    static var lumen_gl_blend_func_separate = load("lumen_gl_blend_func_separate", 4);
    static var lumen_gl_buffer_data = load("lumen_gl_buffer_data", 5);
    static var lumen_gl_buffer_sub_data = load("lumen_gl_buffer_sub_data", 5);
    static var lumen_gl_check_framebuffer_status = load("lumen_gl_check_framebuffer_status", 1);
    static var lumen_gl_clear = load("lumen_gl_clear", 1);
    static var lumen_gl_clear_color = load("lumen_gl_clear_color", 4);
    static var lumen_gl_clear_depth = load("lumen_gl_clear_depth", 1);
    static var lumen_gl_clear_stencil = load("lumen_gl_clear_stencil", 1);
    static var lumen_gl_color_mask = load("lumen_gl_color_mask", 4);
    static var lumen_gl_compile_shader = load("lumen_gl_compile_shader", 1);
    static var lumen_gl_compressed_tex_image_2d = load("lumen_gl_compressed_tex_image_2d", -1);
    static var lumen_gl_compressed_tex_sub_image_2d = load("lumen_gl_compressed_tex_sub_image_2d", -1);
    static var lumen_gl_copy_tex_image_2d = load("lumen_gl_copy_tex_image_2d", -1);
    static var lumen_gl_copy_tex_sub_image_2d = load("lumen_gl_copy_tex_sub_image_2d", -1);
    static var lumen_gl_create_buffer = load("lumen_gl_create_buffer", 0);
    static var lumen_gl_create_framebuffer = load("lumen_gl_create_framebuffer", 0);
    static var lumen_gl_create_program = load("lumen_gl_create_program", 0);
    static var lumen_gl_create_render_buffer = load("lumen_gl_create_render_buffer", 0);
    static var lumen_gl_create_shader = load("lumen_gl_create_shader", 1);
    static var lumen_gl_create_texture = load("lumen_gl_create_texture", 0);
    static var lumen_gl_cull_face = load("lumen_gl_cull_face", 1);
    static var lumen_gl_delete_buffer = load("lumen_gl_delete_buffer", 1);
    static var lumen_gl_delete_framebuffer = load("lumen_gl_delete_framebuffer", 1);
    static var lumen_gl_delete_program = load("lumen_gl_delete_program", 1);
    static var lumen_gl_delete_render_buffer = load("lumen_gl_delete_render_buffer", 1);
    static var lumen_gl_delete_shader = load("lumen_gl_delete_shader", 1);
    static var lumen_gl_delete_texture = load("lumen_gl_delete_texture", 1);
    static var lumen_gl_depth_func = load("lumen_gl_depth_func", 1);
    static var lumen_gl_depth_mask = load("lumen_gl_depth_mask", 1);
    static var lumen_gl_depth_range = load("lumen_gl_depth_range", 2);
    static var lumen_gl_detach_shader = load("lumen_gl_detach_shader", 2);
    static var lumen_gl_disable = load("lumen_gl_disable", 1);
    static var lumen_gl_disable_vertex_attrib_array = load("lumen_gl_disable_vertex_attrib_array", 1);
    static var lumen_gl_draw_arrays = load("lumen_gl_draw_arrays", 3);
    static var lumen_gl_draw_elements = load("lumen_gl_draw_elements", 4);
    static var lumen_gl_enable = load("lumen_gl_enable", 1);
    static var lumen_gl_enable_vertex_attrib_array = load("lumen_gl_enable_vertex_attrib_array", 1);
    static var lumen_gl_finish = load("lumen_gl_finish", 0);
    static var lumen_gl_flush = load("lumen_gl_flush", 0);
    static var lumen_gl_framebuffer_renderbuffer = load("lumen_gl_framebuffer_renderbuffer", 4);
    static var lumen_gl_framebuffer_texture2D = load("lumen_gl_framebuffer_texture2D", 5);
    static var lumen_gl_front_face = load("lumen_gl_front_face", 1);
    static var lumen_gl_generate_mipmap = load("lumen_gl_generate_mipmap", 1);
    static var lumen_gl_get_active_attrib = load("lumen_gl_get_active_attrib", 2);
    static var lumen_gl_get_active_uniform = load("lumen_gl_get_active_uniform", 2);
    static var lumen_gl_get_attrib_location = load("lumen_gl_get_attrib_location", 2);
    static var lumen_gl_get_buffer_paramerter = load("lumen_gl_get_buffer_paramerter", 2);
    static var lumen_gl_get_context_attributes = load("lumen_gl_get_context_attributes", 0);
    ...
    static var lumen_gl_get_shader_info_log = load("lumen_gl_get_shader_info_log", 1);
    static var lumen_gl_get_shader_parameter = load("lumen_gl_get_shader_parameter", 2);
    static var lumen_gl_get_shader_precision_format = load("lumen_gl_get_shader_precision_format", 2);
    static var lumen_gl_get_shader_source = load("lumen_gl_get_shader_source", 1);
    static var lumen_gl_get_supported_extensions = load("lumen_gl_get_supported_extensions", 1);
    static var lumen_gl_get_tex_parameter = load("lumen_gl_get_tex_parameter", 2);
    static var lumen_gl_get_uniform = load("lumen_gl_get_uniform", 2);
    static var lumen_gl_get_uniform_location = load("lumen_gl_get_uniform_location", 2);
    static var lumen_gl_get_vertex_attrib = load("lumen_gl_get_vertex_attrib", 2);
    static var lumen_gl_get_vertex_attrib_offset = load("lumen_gl_get_vertex_attrib_offset", 2);
    static var lumen_gl_hint = load("lumen_gl_hint", 2);
    static var lumen_gl_is_buffer = load("lumen_gl_is_buffer", 1);
    static var lumen_gl_is_enabled = load("lumen_gl_is_enabled", 1);
    static var lumen_gl_is_framebuffer = load("lumen_gl_is_framebuffer", 1);
    static var lumen_gl_is_program = load("lumen_gl_is_program", 1);
    static var lumen_gl_is_renderbuffer = load("lumen_gl_is_renderbuffer", 1);
    static var lumen_gl_is_shader = load("lumen_gl_is_shader", 1);
    static var lumen_gl_is_texture = load("lumen_gl_is_texture", 1);
    static var lumen_gl_line_width = load("lumen_gl_line_width", 1);
    static var lumen_gl_link_program = load("lumen_gl_link_program", 1);
    static var lumen_gl_pixel_storei = load("lumen_gl_pixel_storei", 2);
    static var lumen_gl_polygon_offset = load("lumen_gl_polygon_offset", 2);
    static var lumen_gl_read_pixels = load("lumen_gl_read_pixels", -1);
    static var lumen_gl_renderbuffer_storage = load("lumen_gl_renderbuffer_storage", 4);
    static var lumen_gl_sample_coverage = load("lumen_gl_sample_coverage", 2);
    static var lumen_gl_scissor = load("lumen_gl_scissor", 4);
    static var lumen_gl_shader_source = load("lumen_gl_shader_source", 2);
    static var lumen_gl_stencil_func = load("lumen_gl_stencil_func", 3);
    static var lumen_gl_stencil_func_separate = load("lumen_gl_stencil_func_separate", 4);
    static var lumen_gl_stencil_mask = load("lumen_gl_stencil_mask", 1);
    static var lumen_gl_stencil_mask_separate = load("lumen_gl_stencil_mask_separate", 2);
    static var lumen_gl_stencil_op = load("lumen_gl_stencil_op", 3);
    static var lumen_gl_stencil_op_separate = load("lumen_gl_stencil_op_separate", 4);
    static var lumen_gl_tex_image_2d = load("lumen_gl_tex_image_2d", -1);
    static var lumen_gl_tex_parameterf = load("lumen_gl_tex_parameterf", 3);
    static var lumen_gl_tex_parameteri = load("lumen_gl_tex_parameteri", 3);
    static var lumen_gl_tex_sub_image_2d = load("lumen_gl_tex_sub_image_2d", -1);
    static var lumen_gl_uniform1f = load("lumen_gl_uniform1f", 2);
    static var lumen_gl_uniform1fv = load("lumen_gl_uniform1fv", 2);
    static var lumen_gl_uniform1i = load("lumen_gl_uniform1i", 2);
    static var lumen_gl_uniform1iv = load("lumen_gl_uniform1iv", 2);
    static var lumen_gl_uniform2f = load("lumen_gl_uniform2f", 3);
    static var lumen_gl_uniform2fv = load("lumen_gl_uniform2fv", 2);
    static var lumen_gl_uniform2i = load("lumen_gl_uniform2i", 3);
    static var lumen_gl_uniform2iv = load("lumen_gl_uniform2iv", 2);
    static var lumen_gl_uniform3f = load("lumen_gl_uniform3f", 4);
    static var lumen_gl_uniform3fv = load("lumen_gl_uniform3fv", 2);
    static var lumen_gl_uniform3i = load("lumen_gl_uniform3i", 4);
    static var lumen_gl_uniform3iv = load("lumen_gl_uniform3iv", 2);
    static var lumen_gl_uniform4f = load("lumen_gl_uniform4f", 5);
    static var lumen_gl_uniform4fv = load("lumen_gl_uniform4fv", 2);
    static var lumen_gl_uniform4i = load("lumen_gl_uniform4i", 5);
    static var lumen_gl_uniform4iv = load("lumen_gl_uniform4iv", 2);
    static var lumen_gl_uniform_matrix = load("lumen_gl_uniform_matrix", 4);
    static var lumen_gl_use_program = load("lumen_gl_use_program", 1);
    static var lumen_gl_validate_program = load("lumen_gl_validate_program", 1);
    static var lumen_gl_version = load("lumen_gl_version", 0);
    static var lumen_gl_vertex_attrib1f = load("lumen_gl_vertex_attrib1f", 2);
    static var lumen_gl_vertex_attrib1fv = load("lumen_gl_vertex_attrib1fv", 2);
    static var lumen_gl_vertex_attrib2f = load("lumen_gl_vertex_attrib2f", 3);
    static var lumen_gl_vertex_attrib2fv = load("lumen_gl_vertex_attrib2fv", 2);
    static var lumen_gl_vertex_attrib3f = load("lumen_gl_vertex_attrib3f", 4);
    static var lumen_gl_vertex_attrib3fv = load("lumen_gl_vertex_attrib3fv", 2);
    static var lumen_gl_vertex_attrib4f = load("lumen_gl_vertex_attrib4f", 5);
