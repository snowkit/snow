...
// bindings
    ...
    static var alhx_DopplerFactor           = Libs.load("lumen", "alhx_DopplerFactor", 1);
    static var alhx_DopplerVelocity         = Libs.load("lumen", "alhx_DopplerVelocity", 1);
    static var alhx_SpeedOfSound            = Libs.load("lumen", "alhx_SpeedOfSound", 1);

    static var alhx_DistanceModel           = Libs.load("lumen", "alhx_DistanceModel", 1);
    static var alhx_Enable                  = Libs.load("lumen", "alhx_Enable", 1);
    static var alhx_Disable                 = Libs.load("lumen", "alhx_Disable", 1);
    static var alhx_IsEnabled               = Libs.load("lumen", "alhx_IsEnabled", 1);
    static var alhx_GetString               = Libs.load("lumen", "alhx_GetString", 1);
    static var alhx_GetBooleanv             = Libs.load("lumen", "alhx_GetBooleanv", 2);
    static var alhx_GetIntegerv             = Libs.load("lumen", "alhx_GetIntegerv", 2);
    static var alhx_GetFloatv               = Libs.load("lumen", "alhx_GetFloatv", 2);
    static var alhx_GetDoublev              = Libs.load("lumen", "alhx_GetDoublev", 2);
    static var alhx_GetBoolean              = Libs.load("lumen", "alhx_GetBoolean", 1);
    ...
    static var alhx_GetEnumValue            = Libs.load("lumen", "alhx_GetEnumValue", 1);

    static var alhx_Listenerf               = Libs.load("lumen", "alhx_Listenerf", 2);
    static var alhx_Listener3f              = Libs.load("lumen", "alhx_Listener3f", 4);
    static var alhx_Listenerfv              = Libs.load("lumen", "alhx_Listenerfv", 2);
    static var alhx_Listeneri               = Libs.load("lumen", "alhx_Listeneri", 2);
    static var alhx_Listener3i              = Libs.load("lumen", "alhx_Listener3i", 4);
    static var alhx_Listeneriv              = Libs.load("lumen", "alhx_Listeneriv", 2);

    static var alhx_GetListenerf            = Libs.load("lumen", "alhx_GetListenerf", 1);
    static var alhx_GetListener3f           = Libs.load("lumen", "alhx_GetListener3f", 1);
    static var alhx_GetListenerfv           = Libs.load("lumen", "alhx_GetListenerfv", 2);
    static var alhx_GetListeneri            = Libs.load("lumen", "alhx_GetListeneri", 1);
    static var alhx_GetListener3i           = Libs.load("lumen", "alhx_GetListener3i", 1);
    static var alhx_GetListeneriv           = Libs.load("lumen", "alhx_GetListeneriv", 2);

    static var alhx_GenSources              = Libs.load("lumen", "alhx_GenSources", 1);
    static var alhx_DeleteSources           = Libs.load("lumen", "alhx_DeleteSources", 2);
    static var alhx_IsSource                = Libs.load("lumen", "alhx_IsSource", 1);

    static var alhx_Sourcef                 = Libs.load("lumen", "alhx_Sourcef", 3);
    static var alhx_Source3f                = Libs.load("lumen", "alhx_Source3f", 5);
    static var alhx_Sourcefv                = Libs.load("lumen", "alhx_Sourcefv", 3);
    static var alhx_Sourcei                 = Libs.load("lumen", "alhx_Sourcei", 3);
    static var alhx_Source3i                = Libs.load("lumen", "alhx_Source3i", 5);
    static var alhx_Sourceiv                = Libs.load("lumen", "alhx_Sourceiv", 3);

    static var alhx_GetSourcef              = Libs.load("lumen", "alhx_GetSourcef", 2);
    static var alhx_GetSource3f             = Libs.load("lumen", "alhx_GetSource3f", 2);
    static var alhx_GetSourcefv             = Libs.load("lumen", "alhx_GetSourcefv", 2);
    static var alhx_GetSourcei              = Libs.load("lumen", "alhx_GetSourcei", 2);
    static var alhx_GetSource3i             = Libs.load("lumen", "alhx_GetSource3i", 2);
    static var alhx_GetSourceiv             = Libs.load("lumen", "alhx_GetSourceiv", 3);

    static var alhx_SourcePlayv             = Libs.load("lumen", "alhx_SourcePlayv", 2);
    static var alhx_SourceStopv             = Libs.load("lumen", "alhx_SourceStopv", 2);
    static var alhx_SourceRewindv           = Libs.load("lumen", "alhx_SourceRewindv", 2);
    ...
    static var alhx_SourceRewind            = Libs.load("lumen", "alhx_SourceRewind", 1);
    static var alhx_SourcePause             = Libs.load("lumen", "alhx_SourcePause", 1);
    ...
    static var alhx_Buffer3f                = Libs.load("lumen", "alhx_Buffer3f", 5);
    static var alhx_Bufferfv                = Libs.load("lumen", "alhx_Bufferfv", 3);
    static var alhx_Bufferi                 = Libs.load("lumen", "alhx_Bufferi", 3);
    static var alhx_Buffer3i                = Libs.load("lumen", "alhx_Buffer3i", 5);
    static var alhx_Bufferiv                = Libs.load("lumen", "alhx_Bufferiv", 3);

    static var alhx_GetBufferf              = Libs.load("lumen", "alhx_GetBufferf", 2);
    static var alhx_GetBuffer3f             = Libs.load("lumen", "alhx_GetBuffer3f", 2);
    static var alhx_GetBufferfv             = Libs.load("lumen", "alhx_GetBufferfv", 3);
    static var alhx_GetBufferi              = Libs.load("lumen", "alhx_GetBufferi", 2);
    static var alhx_GetBuffer3i             = Libs.load("lumen", "alhx_GetBuffer3i", 2);
    static var alhx_GetBufferiv             = Libs.load("lumen", "alhx_GetBufferiv", 3);

//unofficial API helpers

    static var alhx_GenSource               = Libs.load("lumen", "alhx_GenSource", 0);
    static var alhx_DeleteSource            = Libs.load("lumen", "alhx_DeleteSource", 1);
    static var alhx_GenBuffer               = Libs.load("lumen", "alhx_GenBuffer", 0);
    static var alhx_DeleteBuffer            = Libs.load("lumen", "alhx_DeleteBuffer", 1);
...
//bindings
    ...
    static var alhx_alcCreateContext            = Libs.load("lumen", "alhx_alcCreateContext", 2);
    static var alhx_alcMakeContextCurrent       = Libs.load("lumen", "alhx_alcMakeContextCurrent", 1);
    static var alhx_alcProcessContext           = Libs.load("lumen", "alhx_alcProcessContext", 1);
    static var alhx_alcSuspendContext           = Libs.load("lumen", "alhx_alcSuspendContext", 1);
    static var alhx_alcDestroyContext           = Libs.load("lumen", "alhx_alcDestroyContext", 1);
    static var alhx_alcGetCurrentContext        = Libs.load("lumen", "alhx_alcGetCurrentContext", 0);
    static var alhx_alcGetContextsDevice        = Libs.load("lumen", "alhx_alcGetContextsDevice", 1);

    static var alhx_alcOpenDevice               = Libs.load("lumen", "alhx_alcOpenDevice", 1);
    static var alhx_alcCloseDevice              = Libs.load("lumen", "alhx_alcCloseDevice", 1);

    static var alhx_alcGetError                 = Libs.load("lumen", "alhx_alcGetError", 1);
    static var alhx_alcGetString                = Libs.load("lumen", "alhx_alcGetString", 2);
    static var alhx_alcGetIntegerv              = Libs.load("lumen", "alhx_alcGetIntegerv", 3);
