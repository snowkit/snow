...
class ByteArray extends Bytes implements ArrayAccess<Int> implements IDataInput implements IMemoryRange {
    ...
    public function compress(algorithm:Compression = null) : Void {
        ...
        if (algorithm == Compression.LZMA) {
            ...
            result = Bytes.ofData(lumen_lzma_encode( cast src.getData()) );
    ...
    public function uncompress( algorithm:Compression = null ) : Void {
        ...
        if (algorithm == Compression.LZMA) {
            ...
            result = Bytes.ofData( lumen_lzma_decode(src.getData()) );
...
// File IO
        ...
        public function writeFile(inString:String):Void {
            ...
            lumen_byte_array_overwrite_file( inString, this );
...
//Internal
    ...
    static var lumen_lzma_encode    = Libs.load("lumen", "lumen_lzma_encode", 1);
    static var lumen_lzma_decode    = Libs.load("lumen", "lumen_lzma_decode", 1);

    #if !lumen_no_bytearray_io

        static var lumen_byte_array_overwrite_file =    Libs.load("lumen","lumen_byte_array_overwrite_file", 2);
        static var lumen_byte_array_read_file =         Libs.load("lumen", "lumen_byte_array_read_file", 1);
